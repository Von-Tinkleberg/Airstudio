...
import { getObjectTutorialIds } from '../../../Utils/AirStudioServices/Tutorial';
...
export const ChildrenOverridingDepreciationAlert = (): React.Node => {
  return (
    <AlertMessage kind="warning">
      <MarkdownText
        translatableSource={t`Children configurations are deprecated. This [migration documentation](https://docs.airstudio.io/AirStudio5/objects/custom-objects-prefab-template/migrate-to-variants/) can help you use variants instead.`}
        isStandaloneText
      />
    </AlertMessage>
  );
...
export const isVariantEditable = (
  ...
  return (
    ...
    (!!getVariantName(eventsBasedObject, customObjectConfiguration) ||
      eventsFunctionsExtension.getOriginName() !== 'AirStudio-extension-store')
  );
};
