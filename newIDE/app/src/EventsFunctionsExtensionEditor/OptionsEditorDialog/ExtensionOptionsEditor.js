...
const HelpPathTextField = ({
  ...
  const helperText = helpPath
    ? (isRelativePath
        ? i18n._(
            t`This is a relative path that will open in the AirStudio wiki.`
          )
  ...
  return (
    <CompactPropertiesEditorRowField
      ...
      markdownDescription={i18n._(
        t`This can either be a URL to a web page, or a path starting with a slash that will be opened in the AirStudio wiki. Leave empty if there is no help page, although it's recommended you eventually write one if you distribute the extension.`
      )}
      field={
