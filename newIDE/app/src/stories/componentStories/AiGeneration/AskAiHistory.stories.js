...
import { type AiRequest } from '../../../Utils/AirStudioServices/Generation';
    ...
    content: [
      {
        ...
        status: 'completed',
        text:
          "Creating a leaderboard for player best scores in AirStudio is straightforward. Here's how you can do it:\n\n1. First, you need to use the Leaderboard extension to handle saving and retrieving scores.",
        annotations: [],
      },
    ],
  },
    ...
    content: [
      {
        ...
        status: 'completed',
        text:
          "Creating a GTA-style game is complex but doable in AirStudio. You'll need to implement several core systems...",
        annotations: [],
      },
    ],
  },
