...
} from '../../../fixtures/AirStudioServicesTestData/FakeGameAndBuildsManager';
import EventsFunctionsExtensionsContext from '../../../EventsFunctionsExtensionsLoader/EventsFunctionsExtensionsContext';
import { fakeEventsFunctionsExtensionsState } from '../../FakeEventsFunctionsExtensionsContext';
import { AirStudioGameApi } from '../../../Utils/AirStudioServices/ApiConfigs';
...
const Template = ({ children }: {| children: React.Node |}) => {
  ...
  axiosMock
    .onPatch(`${AirStudioGameApi.baseUrl}/game/${fakeGame.id}`)
    .reply(200, fakeGame)
    .onAny()
    .reply(501);
