...
export const Default = (): React.Node => (
  <ColumnStackLayout>
    <LineStackLayout>
      ...
      <PriceTag label={<Text>âœ… Owned</Text>} />
    </LineStackLayout>
    <LineStackLayout>
      <div
        style={{
          ...
          backgroundImage:
            "url('https://resources.AirStudio-app.com/assets/Packs/wesxdz skullcup.png?gdUsage=img')",
          aspectRatio: '16 / 9',
          height: 200,
          padding: 10,
          display: 'flex',
    ...
    <LineStackLayout>
      ...
      >
        <PriceTag label={<Text>âœ… Owned</Text>} withOverlay />
      </div>
    </LineStackLayout>
  </ColumnStackLayout>
);
