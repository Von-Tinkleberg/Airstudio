...
import { client as userApiClient } from '../../../../Utils/AirStudioServices/User';
import { cdnClient as assetCdnClient } from '../../../../Utils/AirStudioServices/Asset';
...
export const PublicAsset = (): React.Node => {
  ...
  assetCdnMock
    .onGet(
      `https://resources.AirStudio-app.com/assets-database/assets/${
