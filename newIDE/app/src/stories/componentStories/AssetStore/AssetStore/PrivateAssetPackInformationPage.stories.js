...
import { client as userApiAxiosClient } from '../../../../Utils/AirStudioServices/User';
import { client as shopApiAxiosClient } from '../../../../Utils/AirStudioServices/Shop';
import { type PrivateAssetPackListingData } from '../../../../Utils/AirStudioServices/Shop';
...
const sellerPublicProfile = {
  ...
  description: 'I create asset packs for AirStudio for country-specific food.',
};
...
const privateAssetPack1: PrivateAssetPack = {
  ...
  content: {
    ...
    tiled: 1,
    '9patch': 7,
    'ParticleSystem::ParticleEmitter': 2,
    font: 1,
    partial: 2,
  },
  previewImageUrls: [
    ...
    'https://resources.AirStudio-app.com/assets/Packs/lucid icons pack.png',
    'https://resources.AirStudio-app.com/assets/Packs/wesxdz skullcup.png',
    'https://resources.AirStudio-app.com/assets/Packs/casual buttons pack.png',
  ],
