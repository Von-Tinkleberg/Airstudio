...
export const Default = (): React.Node => {
  ...
  const onOpenConfirmDeleteDialog = async () => {
    const answer = await showDeleteConfirmation({
      ...
      message: t`Youâ€™re about to permanently delete your AirStudio account username@mail.com. You will no longer be able to log into the app with this email address.`,
