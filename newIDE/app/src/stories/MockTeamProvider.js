...
import { fakeAuthenticatedUserWithEducationPlan } from '../fixtures/AirStudioServicesTestData';
...
export const emptySubscriptionPlanMockData = [
  {
    url: `${AirStudioUsageApi.baseUrl}/subscription-plan?includeLegacy=true`,
    method: 'GET',
    status: 200,
