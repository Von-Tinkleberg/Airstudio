...
const inAppTutorialShortHeaders = [
  {
    ...
    contentUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/cameraParallax.json',
    availableLocales: [
      'en',
      'fr',
      'ar',
    ...
    initialTemplateUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/templates/cameraParallax/game.json',
    initialProjectData: {
  ...
  },
  {
    ...
    contentUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/flingGame.json',
  ...
  },
  {
    ...
    contentUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/healthBar.json',
    availableLocales: [
      'en',
      'fr',
      'ar',
    ...
    initialTemplateUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/templates/healthBar/game.json',
  ...
  },
  {
    ...
    contentUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/joystick.json',
    availableLocales: [
      'en',
      'fr',
      'ar',
    ...
    initialTemplateUrl:
      'https://resources.AirStudio-app.com/in-app-tutorials/templates/joystick/game.json',
    initialProjectData: {
      gameScene: 'GameScene',
