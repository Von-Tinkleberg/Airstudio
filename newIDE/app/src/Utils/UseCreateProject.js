...
import { registerGame } from './AirStudioServices/Game';
...
} from './AirStudioServices/Shop';
import {
  createPrivateGameTemplateUrl,
  type CourseChapter,
} from './AirStudioServices/Asset';
    ...
    async (
      ...
      try {
        ...
        if (
          ...
          // any AirStudio services to ask the user to register the game.
