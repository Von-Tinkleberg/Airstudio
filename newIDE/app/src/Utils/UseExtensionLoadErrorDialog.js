...
const downloadUrl = 'https://airstudio.io/download';
...
export const ExtensionLoadErrorDialog = ({
  ...
  return (
    <Dialog
      title={
        <Trans>AirStudio's installation is corrupted and can't be used</Trans>
      }
      actions={[
        Window.isDev() ? (
          <FlatButton
      ...
      // user from trying to use AirStudio with broken extensions.
      cannotBeDismissed
      open
    >
      <ColumnStackLayout noMargin expand>
        ...
        <Text>
          <Trans>
            If you are in a browser, ensure you close all AirStudio tabs or
            restart the browser.
          </Trans>
        </Text>
        <Text>
