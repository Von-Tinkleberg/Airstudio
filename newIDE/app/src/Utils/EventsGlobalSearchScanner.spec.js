...
describe('EventsGlobalSearchScanner', () => {
  ...
  it('finds matches in layout events', () => {
    ...
    // Event 0: comment containing the needle â€” should match.
    ...
    // Event 1: standard event with "Needle" in a condition parameter â€” should match.
    ...
    // Event 2: standard event without the needle anywhere â€” should NOT match.
