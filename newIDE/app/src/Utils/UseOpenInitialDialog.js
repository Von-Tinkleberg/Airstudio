...
import { FLING_GAME_IN_APP_TUTORIAL_ID } from './AirStudioServices/InAppTutorial';
import AuthenticatedUserContext from '../Profile/AuthenticatedUserContext';
import { t } from '@lingui/macro';
import { getListedBundle } from './AirStudioServices/Shop';
        ...
        switch (routeArguments['initial-dialog']) {
          case 'subscription':
            const recommendedPlanId =
              routeArguments['recommended-plan-id'] || 'AirStudio_silver';
