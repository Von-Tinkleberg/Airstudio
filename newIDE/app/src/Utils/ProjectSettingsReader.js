...
const SETTINGS_FILE_NAME = 'AirStudio-settings.yaml';
...
/**
 * Reads and parses the AirStudio-settings.yaml file from a project's root directory.
 * Returns null if:
...
export const readProjectSettings = async (
  ...
  try {
    ...
    console.error(
      `[ProjectSettingsReader] Error reading AirStudio-settings.yaml: ${
        error.message
      }`
    );
    return null;
