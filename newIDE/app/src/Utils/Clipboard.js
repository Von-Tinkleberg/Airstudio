...
const mangleClipboardKind = (kind: ClipboardKind): string => {
  // Mangle the name with AirStudio specific strings and random
  // characters so that the probability that something that is not
  // a valid AirStudio clipboard content is recognized as valid is almost 0.
  return 'AirStudio_' + kind + '_CLIPBOARD_KIND-jsBdHbLy912y8Rc';
};
