...
} from '../AirStudioServices/Extension';
 ...
 */
export const isCompatibleWithAirStudioVersion = (
  ideVersion: string,
  requiredAirStudioVersion: ?string
): boolean =>
  requiredAirStudioVersion
    ? semverSatisfies(ideVersion, requiredAirStudioVersion, {
...
const formatChange = (change: string, indentation: string) =>
