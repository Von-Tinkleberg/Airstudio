...
describe('HelpLink', () => {
  ...
  describe('isDocumentationAbsoluteUrl', () => {
    it('returns true for https URLs', () => {
      ...
      expect(isDocumentationAbsoluteUrl('https://airstudio.io')).toBe(true);
    });
  ...
  describe('getHelpLink', () => {
    it('returns docs link for relative paths', () => {
      expect(getHelpLink('/test')).toBe(
        'https://airstudio.io/docs/AirStudio5/test?utm_source=airstudio&utm_medium=help-link'
      );
    });

    it('returns docs link with anchor for relative paths', () => {
      expect(getHelpLink('/test', 'section1')).toBe(
        'https://airstudio.io/docs/AirStudio5/test?utm_source=airstudio&utm_medium=help-link#section1'
      );
    });
