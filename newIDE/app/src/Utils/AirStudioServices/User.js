...
import { AirStudioUserApi } from './ApiConfigs';
 ...
 */
export type AirStudioTutorialRecommendation = {
...
export type Recommendation =
  | AirStudioTutorialRecommendation
...
export const client: Axios = axios.create({
  baseURL: AirStudioUserApi.baseUrl,
});
...
export const communityLinksConfig = {
  ...
  githubUsername: {
    ...
    getMessageFromUpdate: (
      ...
      if (
        ...
        return {
          ...
          message: t`Thanks for starring AirStudio repository. We added credits to your account as a thank you gift.`,
        };
      } else if (responseCode === 'github-star/repository-not-starred') {
        return {
          title: t`We could not find your GitHub star`,
          message: t`Make sure you star the repository called 4ian/AirStudio with your GitHub user and try again.`,
        };
      } else if (responseCode === 'github-star/user-not-found') {
        return {
          title: t`We could not find your GitHub user and star`,
          message: t`Make sure you create your GitHub account, star the repository called 4ian/AirStudio, enter your username here and try again.`,
        };
      }
      return null;
    },
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string): any =>
      !hasBadge
        ? t`[Star the AirStudio repository](https://github.com/4ian/AirStudio) and add your GitHub username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting the AirStudio open-source community. Credits were added to your account as a thank you.`,
  },
  twitterUsername: {
    ...
    getMessageFromUpdate: (
      ...
      if (
        ...
        return {
          title: t`You're awesome!`,
          message: t`Thanks for following AirStudio. We added credits to your account as a thank you gift.`,
        };
      } else if (responseCode === 'twitter-follow/account-not-followed') {
        return {
          title: t`We could not check your follow`,
          message: t`Make sure you follow the AirStudio account and try again.`,
        };
      } else if (responseCode === 'twitter-follow/user-not-found') {
        return {
          title: t`We could not find your user`,
          message: t`Make sure your username is correct, follow the AirStudio account and try again.`,
        };
      }
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string): any =>
      !hasBadge
        ? t`[Follow AirStudio](https://twitter.com/AirStudioApp) and enter your Twitter username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting AirStudio. Credits were added to your account as a thank you.`,
  },
  facebookUsername: {
  ...
  youtubeUsername: {
    ...
    getMessageFromUpdate: (
      ...
      if (
        ...
        return {
          ...
          message: t`Make sure you subscribed to the AirStudio channel and try again.`,
        };
      } else if (responseCode === 'youtube-subscription/user-not-found') {
        return {
          title: t`We could not find your user`,
          message: t`Make sure your username is correct, subscribe to the AirStudio channel and try again.`,
        };
      }
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string): any =>
      !hasBadge
        ? t`[Subscribe to AirStudio](https://youtube.com/@AirStudioApp) and enter your YouTube username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting AirStudio. Credits were added to your account as a thank you.`,
  },
  tiktokUsername: {
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string): any =>
      !hasBadge
        ? t`[Follow AirStudio](https://tiktok.com/@AirStudio) and enter your TikTok username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting AirStudio. Credits were added to your account as a thank you.`,
  },
  instagramUsername: {
...
export const fetchUserCourseProgress = async (
  ...
  try {
    ...
    const extractedStatusAndCode = extractAirStudioApiErrorStatusAndCode(error);
