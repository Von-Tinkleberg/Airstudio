...
import { AirStudioGameApi, AirStudioGamesPlatform } from './ApiConfigs';
...
export const client: Axios = axios.create({
  baseURL: AirStudioGameApi.baseUrl,
});
...
export const getGameUrl = (game: ?Game): any | null => {
  ...
  return slug
    ? AirStudioGamesPlatform.getGameUrlWithSlug(slug.username, slug.gameSlug)
    : AirStudioGamesPlatform.getGameUrl(game.id);
};
...
export const getPublicGameUrl = (publicGame: ?PublicGame): any | null => {
  ...
  return publicGame.gameSlug && publicGame.userSlug
    ? AirStudioGamesPlatform.getGameUrlWithSlug(
        publicGame.userSlug,
        publicGame.gameSlug
      )
    : AirStudioGamesPlatform.getGameUrl(publicGame.id);
};
