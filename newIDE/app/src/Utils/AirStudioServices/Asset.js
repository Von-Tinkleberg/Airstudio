...
import {
  AirStudioAssetApi,
  AirStudioAssetCdn,
  AirStudioPrivateAssetsStorage,
  AirStudioPrivateGameTemplatesStorage,
  AirStudioPublicAssetResourcesStorageBaseUrl,
  AirStudioPublicAssetResourcesStorageStagingBaseUrl,
} from './ApiConfigs';
...
import { type ExtensionDependency } from '../../Utils/AirStudioServices/Extension';
...
export const client: Axios = axios.create({
  baseURL: AirStudioAssetApi.baseUrl,
});
...
|}): Promise<AllPublicAssets> => {
  ...
  if (assetCdn.baseUrl) {
    AirStudioAssetCdn.baseUrl['live'] =
      assetCdn.baseUrl['live'] || AirStudioAssetCdn.baseUrl['live'];
    AirStudioAssetCdn.baseUrl['staging'] =
      assetCdn.baseUrl['staging'] || AirStudioAssetCdn.baseUrl['staging'];
  }
...
export const getPublicAsset = async (
  ...
  const assetResponse = await cdnClient.get(
    `${AirStudioAssetCdn.baseUrl[environment]}/assets/${
      assetShortHeader.id
    }.json`
  );
...
export const getPrivateAsset = async (
  ...
  const assetUrl = `${
    AirStudioPrivateAssetsStorage.baseUrl
...
export const createPrivateGameTemplateUrl = async (
  ...
  const gameTemplateUrl = `${AirStudioPrivateGameTemplatesStorage.baseUrl}/${
...
export const isPublicAssetResourceUrl = (url: string): boolean =>
  url.startsWith(AirStudioPublicAssetResourcesStorageBaseUrl) ||
  url.startsWith(AirStudioPublicAssetResourcesStorageStagingBaseUrl);
