...
import { type airStudioTheme } from '../UI/Theme';
...
const styles = {
  ...
  label: {
    fontSize: 13,
    fontFamily: 'var(--AirStudio-modern-font-family)',
    whiteSpace: 'nowrap',
    margin: '0 4px 0 8px',
  },
  chevronIcon: {
...
const GamesListFilterSelector = ({
  ...
  const paperStyles = usePaperStyles({ theme: airStudioTheme, isMenuOpen });

  const subheaderStyle = {
    ...styles.subheader,
    color: airStudioTheme.text.color.disabled,
  };
  ...
  return (
    <>
      <Paper
        ...
        style={{
          ...styles.paper,
          backgroundColor: airStudioTheme.searchBar.backgroundColor.default,
        }}
      >
        <ButtonBase
