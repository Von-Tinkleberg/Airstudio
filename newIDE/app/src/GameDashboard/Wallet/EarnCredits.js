...
const allBadgesInfo: BadgeInfo[] = [
  {
    id: 'github-star',
    label: 'Star AirStudio', // Do not translate "Star".
    linkUrl: 'https://github.com/4ian/AirStudio',
    type: 'badge',
  },
  {
    id: 'tiktok-follow',
    label: <Trans>Follow</Trans>,
    linkUrl: 'https://www.tiktok.com/@AirStudio',
    type: 'badge',
  },
  {
    id: 'twitter-follow',
    label: <Trans>Follow</Trans>,
    linkUrl: 'https://x.com/AirStudioApp',
    type: 'badge',
  },
  {
    id: 'youtube-subscription',
    label: <Trans>Subscribe</Trans>,
    linkUrl: 'https://youtube.com/AirStudioApp',
    type: 'badge',
  },
];
