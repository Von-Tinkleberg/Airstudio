...
import { type Leaderboard } from '../../Utils/AirStudioServices/Play';
        ...
        <GetSubscriptionCard
          ...
          label={
            !hasValidSubscription ? (
              <Trans>Upgrade to AirStudio Premium</Trans>
            ) : (
            ...
            <Column noMargin expand>
              ...
              <Text>
                {leaderboardLimits.canMaximumCountPerGameBeIncreased ? (
                  <Trans>
                    Upgrade to AirStudio Premium to get more leaderboards,
                  ...
                  <Trans>
                    To keep using AirStudio leaderboards, consider deleting old,
                    unused leaderboards.
                  </Trans>
                )}
              </Text>
