// @flow
import { type UserLeaderboard } from '../../Utils/AirStudioServices/User';
      ...
      // $FlowFixMe[incompatible-type]
      {
        ...
        userPublicProfile: {
          ...
          communityLinks: {
            ...
            snapchatUsername: '',
            personalWebsiteLink:
              'https://forum.AirStudio.io/u/shark_chum/summary',
            youtubeUsername: '',
          },
          iconUrl:
    ...
    topUserCommentQualityRatings: [
      // $FlowFixMe[incompatible-type]
      {
        ...
        userPublicProfile: {
          ...
          username: 'Bouh',
          createdAt: 1553989202802,
          description: 'Community Manager at AirStudio and early contributor.',
          donateLink:
