// @flow
import { type Tutorial } from '../../Utils/AirStudioServices/Tutorial';
import { type PrivatePdfTutorial } from '../../Utils/AirStudioServices/Asset';
...
export const fakeEducationCurriculumPrivateTutorial: Tutorial = {
  ...
  redeemHintByLocale: {
    en:
      'This tutorial is made for education and accessible to teachers and subscribers to the AirStudio Education plan only.',
  },
  redeemLinkByLocale: {
    en: 'https://AirStudio.io/pricing/education',
  },
  titleByLocale: {
    en: 'Fake education only tutorial',
  },
  descriptionByLocale: {
    en: 'Teach the basics of AirStudio and game creation to your students.',
  },
  type: 'pdf-tutorial',
  ...
  linkByLocale: {
    en:
      'https://api-dev.AirStudio.io/asset/pdf-tutorial/education-curriculum-1/action/redirect-to-pdf',
  },
  thumbnailUrlByLocale: {
    en:
      'https://resources.AirStudio-app.com/tutorials/images/playlists/get-started.png',
  },
  sectionByLocale: {
...
export const fakeTutorials: Array<Tutorial> = [
  fakeEducationCurriculumPrivateTutorial,
  {
    ...
    category: 'education-curriculum',
    linkByLocale: {
      en: 'https://api-dev.AirStudio.io/pdf-tutorial/flappy-cat',
    },
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/flappy-cat.jpg',
    },
    redeemHintByLocale: {
      en:
        'This tutorial is made for education and accessible to teachers and subscribers to the AirStudio Education plan only.',
    },
    redeemLinkByLocale: { en: 'https://AirStudio.io/pricing/education' },
    tagsByLocale: [{ en: 'Single player' }, { en: 'Beginner' }],
    sectionByLocale: { en: 'Practical lessons' },
    gameLink: 'https://gd.games/AirStudio/flappy-cat',
    templateUrl:
      'https://resources.AirStudio-app.com/tutorials/templates/flappy-cat/game.json',
  },
  {
    ...
    category: 'education-curriculum',
    linkByLocale: {
      en: 'https://api-dev.AirStudio.io/pdf-tutorial/angry-pigs',
    },
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/angry-pigs.jpg',
    },
    redeemHintByLocale: {
      en:
        'This tutorial is made for education and accessible to teachers and subscribers to the AirStudio Education plan only.',
  ...
  {
    id: 'education-curriculum-AirStudio-team-careers',
    titleByLocale: {
      en: 'Careers in Tech: AirStudio team interviews',
    },
    descriptionByLocale: {
      en:
        'Interviews with people working at AirStudio: software engineers, designers, marketing...',
    },
    type: 'pdf-tutorial',
    category: 'education-curriculum',
    linkByLocale: {
      en:
        'https://api.AirStudio.io/pdf-tutorial/education-curriculum-AirStudio-team-careers/action/redirect-to-pdf',
    },
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/education-curriculum-AirStudio-team-careers.png',
    },
    isPrivateTutorial: true,
    redeemLinkByLocale: {
      en: 'https://AirStudio.io/pricing/education',
    ...
    redeemHintByLocale: {
      en:
        'These interview are for education and accessible to teachers and subscribers to the AirStudio Education plan only.',
    },
  ...
  },
  {
    ...
    titleByLocale: {
      en: 'AirStudio poster, 50x70 cm (dark)',
    },
    descriptionByLocale: {
      en:
        'A poster (dark version) of AirStudio concepts, perfect for STEM teachers in computer classes or workshops.',
    },
    type: 'pdf-tutorial',
    category: 'education-curriculum',
    linkByLocale: {
      en:
        'https://api.AirStudio.io/pdf-tutorial/education-curriculum-poster-dark-50x70cm/action/redirect-to-pdf',
    },
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/education-curriculum-poster-dark-50x70cm.png',
    },
    isPrivateTutorial: true,
    redeemLinkByLocale: {
      en: 'https://AirStudio.io/pricing/education',
    ...
    redeemHintByLocale: {
      en:
        'This poster is made for education and accessible to teachers and subscribers to the AirStudio Education plan only.',
    },
    sectionByLocale: { en: 'Additional support material' },
    tagsByLocale: [
      {
  ...
  },
  {
    ...
    titleByLocale: {
      en: 'AirStudio poster, 50x70 cm (light)',
    },
    descriptionByLocale: {
      en:
        'A poster (light version) of AirStudio concepts, perfect for STEM teachers in computer classes or workshops.',
    },
    type: 'pdf-tutorial',
    category: 'education-curriculum',
    linkByLocale: {
      en:
        'https://api.AirStudio.io/pdf-tutorial/education-curriculum-poster-light-50x70cm/action/redirect-to-pdf',
    },
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/education-curriculum-poster-light-50x70cm.png',
    },
    isPrivateTutorial: true,
    redeemLinkByLocale: {
      en: 'https://AirStudio.io/pricing/education',
  ...
  },
  {
    ...
    description:
      'Learn the basics of AirStudio and game creation. Start in a few minutes thanks to our playlist of 5 minutes video, and start making your own game today.',
    descriptionByLocale: {
      en:
        'Learn the basics of AirStudio and game creation. Start in a few minutes thanks to our playlist of 5 minutes video, and start making your own game today.',
    },
    ...
    duration: 360,
    link:
      'https://www.youtube.com/watch?v=595-swNh0Mw&list=PL3YlZTdKiS89Kj7IQVPoNElJCWrjZaCC8&ab_channel=AirStudio',
    linkByLocale: {
      en:
        'https://www.youtube.com/watch?v=595-swNh0Mw&list=PL3YlZTdKiS89Kj7IQVPoNElJCWrjZaCC8&ab_channel=AirStudio',
    },
  ...
  },
  {
    ...
    description:
      "Every gamedev knows that setting up menus can be a really time consuming task, but with AirStudio's new custom objects, it's one of the quickest parts of the game making process.",
    descriptionByLocale: {
      en:
        "Every gamedev knows that setting up menus can be a really time consuming task, but with AirStudio's new custom objects, it's one of the quickest parts of the game making process.",
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/plkHd4uPI4U',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/ZXM4E_B0mTM',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      "Create a wave defense game without coding, using AirStudio. We'll try to cover everything in this series from basic gun mechanics to enemies and more. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.",
    descriptionByLocale: {
      en:
        "Create a wave defense game without coding, using AirStudio. We'll try to cover everything in this series from basic gun mechanics to enemies and more. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.",
    },
    ...
    duration: 800,
    link:
      'https://www.youtube.com/watch?v=mckuSpr8vio&list=PL3YlZTdKiS8_R32-DlXGi7YGZNfG7B8Vf&ab_channel=AirStudio',
    linkByLocale: {
      en:
        'https://www.youtube.com/watch?v=mckuSpr8vio&list=PL3YlZTdKiS8_R32-DlXGi7YGZNfG7B8Vf&ab_channel=AirStudio',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/mckuSpr8vio',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'Extensions make game development a LOT easier, giving you functionality that you would otherwise have to create yourself. Saving you time and energy in the process of developing your game. This video was created to show you the most commonly used extensions in the AirStudio game engine, which is a no-code, open-source, free, and easy game engine.\r',
    descriptionByLocale: {
      en:
        'Extensions make game development a LOT easier, giving you functionality that you would otherwise have to create yourself. Saving you time and energy in the process of developing your game. This video was created to show you the most commonly used extensions in the AirStudio game engine, which is a no-code, open-source, free, and easy game engine.\r',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/dqGoJKn3XOQ',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      "This video shows how easy it is to publish your game on gd.games, formerly known as liluo, AirStudio's game hosting platform.",
    descriptionByLocale: {
      en:
        "This video shows how easy it is to publish your game on gd.games, formerly known as liluo, AirStudio's game hosting platform.",
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/WcJSf2_QDPY',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'chatgpt-with-AirStudio',
    title: 'ChatGPT With AirStudio',
    titleByLocale: {
      en: 'ChatGPT With AirStudio',
      fr: 'Utiliser ChatGPT pour AirStudio',
    },
    description:
      "This video goes over the basics of AirStudio by creating a quick example game. AirStudio's no code event system, behaviors and extensions, adding sound effects, and more.",
    descriptionByLocale: {
      en:
        "This video goes over the basics of AirStudio by creating a quick example game. AirStudio's no code event system, behaviors and extensions, adding sound effects, and more.",
      fr:
        'On vous montre comment utiliser ChatGPT pour crÃ©er des jeux vidÃ©o avec AirStudio.',
    },
    type: 'video',
    category: 'official-beginner',
    duration: 365,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/aiE-INCUbuk',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: "ðŸ‡«ðŸ‡· Les types d'objets sous AirStudio\n",
    },
    description:
      "This video goes over the object types in AirStudio, and briefly shows what each one can be used for. This will be useful for any game developers who are just starting out with the engine, or someone who doesn't understand some of the object types.",
    descriptionByLocale: {
      en:
        "This video goes over the object types in AirStudio, and briefly shows what each one can be used for. This will be useful for any game developers who are just starting out with the engine, or someone who doesn't understand some of the object types.",
      fr: "Les diffÃ©rents type d'objets de AirStudio.",
    },
    type: 'video',
    category: 'official-beginner',
    duration: 286,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/KpLAYMSgoDI',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/rBZ3kuvr9G0',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      en: 'Intro: Variables',
      fr: 'ðŸ‡«ðŸ‡· Utiliser les variables avec AirStudio',
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "In this video, we'll take an introductory look at variables. We will learn the differences between scene, global, and object variables, as well as when to use them. The focus here is on concrete examples, so that you can leave with some real ideas of how to apply variables in your own game!",
      fr:
        'Les diffÃ©rents types de variables de AirStudio et surtout dans quel contexte et comment les utiliser.',
    },
    type: 'video',
    category: 'official-beginner',
    duration: 311,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/MFvAd-96LWo',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: "Le gÃ©nÃ©rateur d'expressions de AirStudio",
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "This video goes over the expression builder. What it's used for and what sort's of things it's capable of. It also goes over a practical example of adding health points to a character. This will be useful for any game developers who are just starting out with the engine, or someone who hasn't tried using the expression builder yet.",
      fr:
        'Comment gÃ©nÃ©rer des expressions avec AirStudio sans programmer, quand et comment les utiliser.',
    },
    type: 'video',
    category: 'official-beginner',
    duration: 299,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/huKDtb8Ubd4',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: 'ðŸ‡«ðŸ‡· Les extensions AirStudio',
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "As a game creator, you want to get from concept to finished product as soon as possible. Behaviors and functions (extensions) address this by letting you not reinvent the wheel, so you can focus on actually making your game! In this video, we'll go over the basics of behaviors and functions as well as how you can use them in your next project.",
      fr:
        'PrÃ©sentation des extensions de AirStudio sans programmer, qui permettent de se concentrer sur le gameplay.',
    },
    type: 'video',
    category: 'official-beginner',
    duration: 233,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/-U8WFcpUmMg',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'This video teaches AirStudio users about game optimization, and briefly goes over most of the areas that could be causing lag or poor performance in your game. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video teaches AirStudio users about game optimization, and briefly goes over most of the areas that could be causing lag or poor performance in your game. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
      fr:
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/vXQsWCdtcQE',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/3akue2EwDPU',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/clNM7cODA3c',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/3P82paiVaTQ',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/OsRGf49_Z6E',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/sgap1eR9q4s',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/NWPg_8j5_VM',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/KeX1QLJQskU',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/GR26gkQHK7E',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/w0Ll7FYhRbA',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    titleByLocale: {
      ...
      fr: " ðŸ‡«ðŸ‡· AirStudio c'est quoi?",
    },
    description:
      'How to get started with game dev. Check out AirStudio today!\nAirStudiois a 2D cross-platform, free and open-source game engine.',
    descriptionByLocale: {
      en:
        'How to get started with game dev. Check out AirStudio today!\nAirStudiois a 2D cross-platform, free and open-source game engine.',
      fr:
        'Cette vidÃ©o passe rapidement en revue le fonctionnement de AirStudio, pour comprendre les principaux concepts.',
    },
    type: 'video',
    category: 'official-beginner',
    duration: 429,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/U9vqzH65Zzw',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'Learn how to create games with AirStudio, a 2D cross-platform, free and open-source game engine. You can create games with minimal coding and run them on most major platforms.',
    descriptionByLocale: {
      en:
        'Learn how to create games with AirStudio, a 2D cross-platform, free and open-source game engine. You can create games with minimal coding and run them on most major platforms.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/iHF5fwsqu4I',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'Showing some of the tools you can use in AirStudio that will allow you to fix any problem you might run into while creating your game. Gamedev is stressful enough, use these development tools to help you create your dream game with less of a headache.',
    descriptionByLocale: {
      en:
        'Showing some of the tools you can use in AirStudio that will allow you to fix any problem you might run into while creating your game. Gamedev is stressful enough, use these development tools to help you create your dream game with less of a headache.',
      fr:
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/8krGoBuQpBI',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'Learn deeper concept related to game creation with AirStudio: make multiple levels, add leaderboards to your game, touch controls, save and load, use the physics engine... These videos are the best way to see everything you can do with AirStudio!',
    descriptionByLocale: {
      en:
        'Learn deeper concept related to game creation with AirStudio: make multiple levels, add leaderboards to your game, touch controls, save and load, use the physics engine... These videos are the best way to see everything you can do with AirStudio!',
    },
    ...
    duration: 327,
    link:
      'https://www.youtube.com/watch?v=5NzMs1JRuXA&list=PL3YlZTdKiS89LrdlHcHo5vePN3O3UhGwm&ab_channel=AirStudio',
    linkByLocale: {
      en:
        'https://www.youtube.com/watch?v=5NzMs1JRuXA&list=PL3YlZTdKiS89LrdlHcHo5vePN3O3UhGwm&ab_channel=AirStudio',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/playlists/get-better.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/playlists/get-better.png',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/27e3m906x7I',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'four-ways-to-make-money-with-AirStudio',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/zY5kv50XNnE',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'In this tutorial, we cover the object picking system, which is integral to certain kinds of game behaviors, such as checkpoint systems for instance! These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game making app.',
    descriptionByLocale: {
      en:
        'In this tutorial, we cover the object picking system, which is integral to certain kinds of game behaviors, such as checkpoint systems for instance! These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game making app.',
      fr: 'Comment gÃ©rer des checkpoints avec AirStudio.',
    },
    type: 'video',
    category: 'official-intermediate',
    duration: 242,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/KzC2dHa_SJE',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'This video shows you how to add a leaderboard to your game in the AirStudio game engine. How to set up the leaderboards, customize them, trigger them with events, and display them on screen. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video shows you how to add a leaderboard to your game in the AirStudio game engine. How to set up the leaderboards, customize them, trigger them with events, and display them on screen. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/FOdPORyeU20',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      "You've created a level for your game, but now need to make a second level. How can you do this without copy pasting everything over to a new scene? In fact, AirStudio offers a suite of tools to solve problems like these, which will save you time as a game creator.",
    descriptionByLocale: {
      en:
        "You've created a level for your game, but now need to make a second level. How can you do this without copy pasting everything over to a new scene? In fact, AirStudio offers a suite of tools to solve problems like these, which will save you time as a game creator.",
      fr:
        'Comment utiliser les calques, Ã©vÃ©nements externes et objets globaux pour gagner en productivitÃ© avec AirStudio.',
    },
    type: 'video',
    category: 'official-intermediate',
    duration: 328,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/_VUwAfD_7zQ',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'To finish off our coverage of object types in AirStudio, we go over the two currently experimental types: Bitmap Text and Tiled!',
    descriptionByLocale: {
      en:
        'To finish off our coverage of object types in AirStudio, we go over the two currently experimental types: Bitmap Text and Tiled!',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/tLd5HvqaWcU',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    descriptionByLocale: {
      en:
        "Learn what the different variables' types are for and how to use them.\rBooleans, Arrays, and Structures won't hold any secrets for you anymore!",
      fr:
        'Les variables boolÃ©ennes et des structures de donnÃ©es avec AirStudio.',
    },
    type: 'video',
    category: 'official-intermediate',
    duration: 281,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/0vlCEVUP1YA',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      "This video shows how to create a level select menu. How to create a menu and change scenes, as well as how lock off levels so they can't be accessed until the level before it is beaten. This tutorial will be useful for any game developers using AirStudio, a no-code, open-source, free, and easy game-making app.",
    descriptionByLocale: {
      en:
        "This video shows how to create a level select menu. How to create a menu and change scenes, as well as how lock off levels so they can't be accessed until the level before it is beaten. This tutorial will be useful for any game developers using AirStudio, a no-code, open-source, free, and easy game-making app.",
      fr: 'Comment intÃ©grer des menus et niveaux avec AirStudio.',
    },
    type: 'video',
    category: 'official-intermediate',
    duration: 341,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/tt7ylPTLuVA',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/58AT-cH5gLc',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/vuV_Q_hzACQ',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/KOO9p4XKT8c',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'This video goes over some of the events related to the physics engine in AirStudio. Explaining what forces and impulses are used for, and going over a use case for the revolute joint.(Pinball) These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video goes over some of the events related to the physics engine in AirStudio. Explaining what forces and impulses are used for, and going over a use case for the revolute joint.(Pinball) These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
      fr:
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/HzAFMb_q-a4',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'This video goes over some commonly used expressions, that you will find useful for your games in AirStudio. Showing you where you would use these useful expressions, and why. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video goes over some commonly used expressions, that you will find useful for your games in AirStudio. Showing you where you would use these useful expressions, and why. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
      fr:
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/gGVJb0Mqry8',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      'This video goes over camera controls within the AirStudio game engine. Going over camera movement, zoom, rotation, and camera shake. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video goes over camera controls within the AirStudio game engine. Going over camera movement, zoom, rotation, and camera shake. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/5NzMs1JRuXA',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/mHiEnvE9iqE',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      "As you transcend the basics of AirStudio, you'll want to have things stay the same each time someone opens your game. In this video, we take a look at how to accomplish exactly this!",
    descriptionByLocale: {
      en:
        "As you transcend the basics of AirStudio, you'll want to have things stay the same each time someone opens your game. In this video, we take a look at how to accomplish exactly this!",
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/AXd1nND7zQ0',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/playlists/IndepthSeriesThumbnail.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/playlists/IndepthSeriesThumbnail.png',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: 'ðŸ‡«ðŸ‡· Scores et parties : sauvegarde et chargement avec AirStudio',
    },
    description:
      "As you begin making more advanced games with AirStudio, you'll want to learn this trick to save/load all of your variables with just 3 actions. This will allow you to develop larger games without the worry of your save/load system getting too out of hand.",
    descriptionByLocale: {
      en:
        "As you begin making more advanced games with AirStudio, you'll want to learn this trick to save/load all of your variables with just 3 actions. This will allow you to develop larger games without the worry of your save/load system getting too out of hand.",
      fr: 'Comment enregistrer vos scores ou vos parties avec AirStudio.',
    },
    type: 'video',
    category: 'official-advanced',
    duration: 331,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Fm-BJDTaBCg',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      "In this video we'll be exporting a game from AirStudio. We'll be exporting both a html game file and a PC build. This video will also show people how to upload that exported game to itch.io, as well as good practices to ensure your game can be found when you search for games made with the AirStudio engine.",
    descriptionByLocale: {
      en:
        "In this video we'll be exporting a game from AirStudio. We'll be exporting both a html game file and a PC build. This video will also show people how to upload that exported game to itch.io, as well as good practices to ensure your game can be found when you search for games made with the AirStudio engine.",
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Q4FVvDfSzwk',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'in-depth-tweens',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/vdYi8Miwv2E',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/V0d93elLHkQ',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'This video goes over the top down movement behavior. How to use it, and what sort of conditions relate to the behavior. We show you the different styles of movement that can come from the behavior as well as how to achieve an isometric or 2.5D game effect with Z-ordering. This tutorial will be useful for any game developers using AirStudio, a no-code, open-source, free, and easy game-making app.',
    descriptionByLocale: {
      en:
        'This video goes over the top down movement behavior. How to use it, and what sort of conditions relate to the behavior. We show you the different styles of movement that can come from the behavior as well as how to achieve an isometric or 2.5D game effect with Z-ordering. This tutorial will be useful for any game developers using AirStudio, a no-code, open-source, free, and easy game-making app.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/zUV-lUtXpO4',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'This video goes over the basics of the physics engine in AirStudio. What the various options do within the behavior page, and some examples of how to use it. As well as how to make a basic brick breaker game. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game making app.',
    descriptionByLocale: {
      en:
        'This video goes over the basics of the physics engine in AirStudio. What the various options do within the behavior page, and some examples of how to use it. As well as how to make a basic brick breaker game. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game making app.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/cPwUh1669Gs',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'This video goes over the basics of the particle emitter object in AirStudio. What the various options do within the object page, and some examples of how to use it. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video goes over the basics of the particle emitter object in AirStudio. What the various options do within the object page, and some examples of how to use it. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/mqXYlsOENpg',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'in-depth-sprite',
    ...
    description:
      'This video goes over the sprite object for the AirStudio game engine. Going over collision masks, points, and animations while explaining the use cases for those tools. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    descriptionByLocale: {
      en:
        'This video goes over the sprite object for the AirStudio game engine. Going over collision masks, points, and animations while explaining the use cases for those tools. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/2eOhvUIL4vg',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'geometry-monster',
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/geometry-monster?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/geometry-monster?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/geometry-monster.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/geometry-monster.png',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: 'ðŸ‡«ðŸ‡· CrÃ©er un jeu de plateforme avec AirStudio',
    },
    description:
      'Learn how to make a Platformer game from scratch! Starting from zero, you will learn how to make a fun platform game, using assets found in the AirStudio asset store.',
    descriptionByLocale: {
      en:
        'Learn how to make a Platformer game from scratch! Starting from zero, you will learn how to make a fun platform game, using assets found in the AirStudio asset store.',
      fr: 'Comment crÃ©er un jeu de plateforme avec AirStudio.',
    },
    type: 'video',
    category: 'full-game',
    duration: 392,
    link:
      'https://www.youtube.com/watch?v=eU0kkLSdw0Y&list=PL3YlZTdKiS898Wio0tvKjQM0x3zo4V0Mb&ab_channel=AirStudio',
    linkByLocale: {
      en:
        'https://www.youtube.com/watch?v=eU0kkLSdw0Y&list=PL3YlZTdKiS898Wio0tvKjQM0x3zo4V0Mb&ab_channel=AirStudio',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/playlists/platformer.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/playlists/platformer.png',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/mWiLZ6fYXTU',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/b2eavtLhftI',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    descriptionByLocale: {
      en:
        "Create a wave defense game without coding, using AirStudio. We'll try to cover everything in this series from basic gun mechanics to enemies and more. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.",
      fr:
        "CrÃ©ez un jeu de dÃ©fense contre des vagues d'ennemis en utilisant AirStudio. Dans cette sÃ©rie de didacticiels adaptÃ©s aux dÃ©butants, nous aborderons les mouvements des joueurs, le tir d'une balle, la logique de l'ennemi et l'apparition des ennemis.",
    },
    type: 'video',
    category: 'full-game',
    duration: 800,
  ...
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Qn85BbnSO5A',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    duration: 413,
    link:
      'https://www.youtube.com/watch?v=w1SCpQ-mRCk&list=PL3YlZTdKiS8_Q8UPu2BJV5P5gYA-Q-k19&ab_channel=AirStudio',
    linkByLocale: {
      en:
        'https://www.youtube.com/watch?v=w1SCpQ-mRCk&list=PL3YlZTdKiS8_Q8UPu2BJV5P5gYA-Q-k19&ab_channel=AirStudio',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/playlists/asteroids.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/playlists/asteroids.png',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/YTHodqxuvPQ',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Y2lI3JcJLV8',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/S_mLYcmElBQ',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/It0-QxpQtII',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    description:
      "Stardew Valley is a great game created by a solo developer, and we thought it would be useful for game developers to see a video explaining some of it's mechanics, and how to add those mechanics to their game in AirStudio.",
    descriptionByLocale: {
      en:
        "Stardew Valley is a great game created by a solo developer, and we thought it would be useful for game developers to see a video explaining some of it's mechanics, and how to add those mechanics to their game in AirStudio.",
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/PPKw2kLk9IE',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'With Pokemon scarlet and violet coming out, we decided show game developers how to go about creating a top down rpg game in AirStudio. With top down movement and turn based battles, similar to pokemon.',
    descriptionByLocale: {
      en:
        'With Pokemon scarlet and violet coming out, we decided show game developers how to go about creating a top down rpg game in AirStudio. With top down movement and turn based battles, similar to pokemon.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/tDIiWk6V1Z4',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'cookie-clicker',
    ...
    description:
      'Idle clicker games are incredibly popular, and surprisingly easy to make. So in this video we show how to add clicker game mechanics to your game with AirStudio.',
    descriptionByLocale: {
      en:
        'Idle clicker games are incredibly popular, and surprisingly easy to make. So in this video we show how to add clicker game mechanics to your game with AirStudio.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/I6Dez_6bbb4',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/eU0kkLSdw0Y',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: 'CrÃ©er un jeu de plateforme avec AirStudio - 2Ã¨me Partie',
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "In this video we'll be adding 2 types of enemies to our platformer game. We'll be going through this tutorial at a fairly quick pace because you should have watched our other tutorials before watching this video. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.",
      fr:
        "La 2Ã¨me partie consacrÃ©e Ã  la crÃ©ation d'un jeu de plateforme avec AirStudio.",
    },
    type: 'video',
    category: 'full-game',
    duration: 361,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Li4vhL1bXLc',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: 'ðŸ‡«ðŸ‡· CrÃ©er un jeu de plateforme avec AirStudio - 3Ã¨me Partie',
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "In this platformer example video we'll be going over ladders, a checkpoint system, the parallaxing background, and a win screen with a points system. We'll be going through this tutorial at a fairly quick pace because you should have watched our other tutorials before watching this video. These tutorials are designed to teach you how to make a game in AirStudio, a no-code, open-source, free, and easy game engine.",
      fr:
        "La 3Ã¨me partie consacrÃ©e Ã  la crÃ©ation d'un jeu de plateforme avec AirStudio.",
    },
    type: 'video',
    category: 'full-game',
    duration: 518,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/RgClpUyeTGo',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: "ðŸ‡«ðŸ‡· CrÃ©er un jeu d'asteroÃ¯des avec AirStudio",
    },
    description:
      "In this video we'll be recreating asteroids using the physics behavior that comes with AirStudio by default. We'll be going through this tutorial at a fairly quick pace because you should have watched the intro tutorial playlist before watching this video.",
    descriptionByLocale: {
      en:
        "In this video we'll be recreating asteroids using the physics behavior that comes with AirStudio by default. We'll be going through this tutorial at a fairly quick pace because you should have watched the intro tutorial playlist before watching this video.",
      fr: 'Comment crÃ©er un jeu dâ€™astÃ©roÃ¯des avec AirStudio.',
    },
    type: 'video',
    category: 'full-game',
    duration: 413,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/w1SCpQ-mRCk',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    titleByLocale: {
      ...
      fr: "ðŸ‡«ðŸ‡· CrÃ©er un jeu d'asteroÃ¯des avec AirStudio - la suite",
    },
    description:
    ...
    descriptionByLocale: {
      en:
        "In this video we'll be adding game juice. Which is basically particle effects, sound effects, screen shake, and everything that makes a game feel good to play. If you haven't watched the first video in this 2 part series, be sure to do so because it goes over how we actually built this game.",
      fr:
        'Voici la suite de la vidÃ©o qui vous montre comment crÃ©er un jeu dâ€™astÃ©roÃ¯des avec AirStudio sans programmer.',
    },
    type: 'video',
    category: 'full-game',
    duration: 269,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/z3C89rEp6YA',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/platformer/start?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/platformer/start?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/platformer.png',
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/platformer.png',
    },
  },
  {
    id: 'space-shooter',
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/space-shooter?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/space-shooter?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/space-shooter.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/space-shooter.png',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/2d-car-physics-movement.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/2d-car-physics-movement.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/2d-platformer-shooter.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/2d-platformer-shooter.jpg',
    },
  },
  {
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/tank-shooter?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/tank-shooter?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/TankShooter.jpg',
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/TankShooter.jpg',
    },
  },
  {
    id: 'endless-runner',
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/endless-runner?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/endless-runner?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/EndlessRunner.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/EndlessRunner.jpg',
    },
  },
  {
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/roadrider?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/roadrider?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/EndlessCar.jpg',
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/EndlessCar.jpg',
    },
  },
  {
    ...
    category: 'full-game',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/breakout?utm_source=AirStudio&utm_medium=help-link',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/breakout?utm_source=AirStudio&utm_medium=help-link',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/Breakout.jpg',
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/Breakout.jpg',
    },
  },
  {
    ...
    link:
      'https://AirStudio.io/page/how-to-make-a-good-game-the-tips-and-mistakes-to-avoid',
    linkByLocale: {
      en:
        'https://AirStudio.io/page/how-to-make-a-good-game-the-tips-and-mistakes-to-avoid',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/b4d5d9b9f5661fca5be4522b578ffceb2d89c5e6-1200x630.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/b4d5d9b9f5661fca5be4522b578ffceb2d89c5e6-1200x630.png',
    },
  },
  {
    ...
    type: 'text',
    category: 'game-mechanic',
    link: 'https://AirStudio.io/page/best-practices-when-making-games',
    linkByLocale: {
      en: 'https://AirStudio.io/page/best-practices-when-making-games',
    },
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/best-practices-when-making-games.png',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/best-practices-when-making-games.png',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/9ReOBFoSD3g',
    thumbnailUrlByLocale: {
      en: '',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/-0z7ZlLZNJQ',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/OzjEQTEQwFg',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/emkqM9I8sQU',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'nocode-three-d-extension',
    title: '3D No-Code Game - A AirStudio Community Extension',
    titleByLocale: {
      en: '3D No-Code Game - A AirStudio Community Extension',
    },
    description:
      'It is possible to create a 3D game using AirStudio with an extension that was created by PANDAKO, who is a long time AirStudio user and community member. ',
    descriptionByLocale: {
      en:
        'It is possible to create a 3D game using AirStudio with an extension that was created by PANDAKO, who is a long time AirStudio user and community member. ',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/No9FlRmbvO8',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description:
      'This video shows game developers using AirStudio how to easily implement melee combat in their game. Showing two different kinds of attacks, and how to make enemies attack the player.',
    descriptionByLocale: {
      en:
        'This video shows game developers using AirStudio how to easily implement melee combat in their game. Showing two different kinds of attacks, and how to make enemies attack the player.',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/ZjxWwf7RslU',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/5C78xIecgiI',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/LLPtMO_ov-w',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'create-enemy-ai',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/0aGBYsrGwm0',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/zi1nI_p_KAw',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/mE-7YM2TZto',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/y_gMhdm9Ils',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/NdAWl17fcKY',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/ORiZPYFqjHM',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/jnuK5SzG0p4',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/yQ-Cbm0HHww',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/JhuRRwxrXF8',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/_pQsEcY7rfk',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/PMkqsAApUlI',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'animated-buttons',
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/animated-buttons.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/animated-buttons.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/character-selection-feature.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/character-selection-feature.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/flickering-dynamic-light-effect.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/flickering-dynamic-light-effect.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/ghost-enemy-following-player.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/ghost-enemy-following-player.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/health-bar-and-health-potion.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/health-bar-and-health-potion.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/melee-sword-attack.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/melee-sword-attack.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/opening-chest.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/opening-chest.jpg',
    },
  },
  {
    ...
    description:
      'Learn how to use particle emitters in AirStudio to create effects like fire, explosion, magic beam, etc...',
    descriptionByLocale: {
      en:
        'Learn how to use particle emitters in AirStudio to create effects like fire, explosion, magic beam, etc...',
    },
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/particle-effects.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/particle-effects.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/pause-menu.jpg',
    thumbnailUrlByLocale: {
      en: 'https://resources.AirStudio-app.com/tutorials/images/pause-menu.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/physics-engine-platformer-game.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/physics-engine-platformer-game.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/push-objects.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/push-objects.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/responsive-ui.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/responsive-ui.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/screen-shake-timer-variables.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/screen-shake-timer-variables.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/simple-game-physics-particles.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/simple-game-physics-particles.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/simple-trampoline-platformer.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/simple-trampoline-platformer.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/smooth-camera-movement.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/smooth-camera-movement.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/touch-360-joystick-controller.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/touch-360-joystick-controller.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/tween-behavior.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/tween-behavior.jpg',
    },
  },
  {
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/save-and-load.jpg',
    thumbnailUrlByLocale: {
      en:
        'https://resources.AirStudio-app.com/tutorials/images/save-and-load.jpg',
    },
  },
  {
    ...
    title: 'Use AirStudio to Teach Logic to Kids',
    titleByLocale: {
      en: 'Use AirStudio to Teach Logic to Kids',
    },
    description: 'Get ideas about how to use AirStudio as a teaching tool.',
    descriptionByLocale: {
      en: 'Get ideas about how to use AirStudio as a teaching tool.',
    },
    type: 'text',
    category: 'recommendations',
    link: 'https://AirStudio.io/blog/turning-teens-into-teachers-1',
    linkByLocale: {
      en: 'https://AirStudio.io/blog/turning-teens-into-teachers-1',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/all-features/audio/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/all-features/audio/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    id: 'wiki-prefabs',
    title: 'Does AirStudio Have Prefabs?',
    titleByLocale: {
      en: 'Does AirStudio Have Prefabs?',
    },
    description:
      'Discover AirStudio Prefabs to speed up your game development journey.',
    descriptionByLocale: {
      en:
        'Discover AirStudio Prefabs to speed up your game development journey.',
    },
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/objects/custom-objects-prefab-template/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/objects/custom-objects-prefab-template/',
    },
  ...
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/tutorials/basic-game-making-concepts/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/tutorials/basic-game-making-concepts/',
    },
  ...
  },
  {
    ...
    title: 'All AirStudio Extensions',
    titleByLocale: {
      en: 'All AirStudio Extensions',
    },
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/extensions/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/extensions/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    title: 'Top 10 AirStudio Games of 2022',
    titleByLocale: {
      en: 'Top 10 AirStudio Games of 2022',
    },
    description:
      'Discover our top ten of the best games made with AirStudio in 2022',
    descriptionByLocale: {
      en: 'Discover our top ten of the best games made with AirStudio in 2022',
    },
    type: 'video',
    category: 'recommendations',
    duration: 646,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/vhVT_avcFgA',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    description: 'How can you use Javascript in AirStudio?',
    descriptionByLocale: {
      en: 'How can you use Javascript in AirStudio?',
    },
    type: 'video',
    category: 'recommendations',
    duration: 343,
    ...
    thumbnailUrl:
      'https://resources.AirStudio-app.com/tutorials/images/cv3qn-M4OH0',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/publishing/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/publishing/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    title: 'Making Interactive Games to Teach on AirStudio',
    titleByLocale: {
      en: 'Making Interactive Games to Teach on AirStudio',
    },
    description:
      'Read about how AirStudio was used to create educational content for students.',
    descriptionByLocale: {
      en:
        'Read about how AirStudio was used to create educational content for students.',
    },
    ...
    category: 'recommendations',
    link:
      'https://AirStudio.io/blog/using-AirStudio-in-eu-backed-projects-in-croatia',
    linkByLocale: {
      en:
        'https://AirStudio.io/blog/using-AirStudio-in-eu-backed-projects-in-croatia',
    },
  ...
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/all-features/admob/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/all-features/admob/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/all-features/firebase/realtime_database/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/all-features/firebase/realtime_database/',
    },
  ...
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/publishing/publish-to-steam/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/publishing/publish-to-steam/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://AirStudio.io/page/how-to-publish-game-on-epic-games-store-and-why-you-should',
    linkByLocale: {
      en:
        'https://AirStudio.io/page/how-to-publish-game-on-epic-games-store-and-why-you-should',
    },
  ...
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://AirStudio.io/page/how-to-publish-your-game-on-newgrounds-and-why-you-should-do-it',
    linkByLocale: {
      en:
        'https://AirStudio.io/page/how-to-publish-your-game-on-newgrounds-and-why-you-should-do-it',
    },
  ...
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/publishing/android_and_ios_with_cordova/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/publishing/android_and_ios_with_cordova/',
    },
  ...
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/publishing/android_and_ios/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/publishing/android_and_ios/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/publishing/publishing-to-amazon-app-store/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/publishing/publishing-to-amazon-app-store/',
    },
  ...
  },
  {
    ...
    type: 'text',
    category: 'recommendations',
    link: 'https://wiki.AirStudio.io/AirStudio5/publishing/windows-macos-linux/',
    linkByLocale: {
      en: 'https://wiki.AirStudio.io/AirStudio5/publishing/windows-macos-linux/',
    },
    thumbnailUrl: '',
    thumbnailUrlByLocale: {},
  },
  {
    ...
    category: 'recommendations',
    link:
      'https://wiki.AirStudio.io/AirStudio5/publishing/html5_game_in_a_local_folder/',
    linkByLocale: {
      en:
        'https://wiki.AirStudio.io/AirStudio5/publishing/html5_game_in_a_local_folder/',
    },
