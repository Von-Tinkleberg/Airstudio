// @flow
import { type Achievement } from '../../Utils/AirStudioServices/Badge';
...
export const fakeAchievements: Array<Achievement> = [
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconName: 'scenes',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/scenes.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/objects.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    shortDescriptionByLocale: { en: '' },
    iconName: 'preview',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/preview.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    shortDescriptionByLocale: { en: '' },
    iconName: 'publishing',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/publishing.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    shortDescriptionByLocale: { en: '' },
    iconName: 'debugger',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/debugger.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/extension-user.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconLevel: 1,
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/game-sessions-1.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconLevel: 2,
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/game-sessions-2.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    iconLevel: 3,
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/game-sessions-3.svg',
  ...
  // $FlowFixMe[incompatible-type]
  {
    ...
    id: 'github-star',
    description: 'You put a star for AirStudio on GitHub - thank you!',
    descriptionByLocale: {
      en: 'You put a star for AirStudio on GitHub - thank you!',
    },
    shortDescriptionByLocale: { en: 'Star the AirStudio open-source project.' },
    rewardValueInCredits: 100,
    iconName: 'github-star',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/github-star.svg',
    publicDescription: "{user}Â starred AirStudio's source code on GitHub",
    publicDescriptionByLocale: {
      en: "{user}Â starred AirStudio's source code on GitHub",
    },
  },
  // $FlowFixMe[incompatible-type]
  {
    ...
    category: 'Marketer',
    id: 'marketer',
    description: 'Thank you for representing AirStudio in a major event!',
    descriptionByLocale: {
      en: 'Thank you for representing AirStudio in a major event!',
    },
    shortDescriptionByLocale: { en: '' },
    iconName: 'marketer',
    iconUrl: 'https://resources.AirStudio-app.com/badges/icons/marketer.svg',
    publicDescription: '{user} represented AirStudio in a major event',
    publicDescriptionByLocale: {
      en: '{user} represented AirStudio in a major event',
    },
  },
  // $FlowFixMe[incompatible-type]
  {
    ...
    category: 'Contributor',
    id: 'tiktok-follow',
    description: 'You follow AirStudio on Tiktok - thank you!',
    descriptionByLocale: { en: 'You follow AirStudio on Tiktok - thank you!' },
    shortDescriptionByLocale: { en: 'Follow AirStudio on TikTok.' },
    rewardValueInCredits: 80,
    iconName: 'tiktok-follow',
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/twitter-follow.svg',
    publicDescription: "{user}Â subscribed to AirStudio's account on TikTok",
    publicDescriptionByLocale: {
      en: "{user}Â subscribed to AirStudio's account on TikTok",
    },
  },
  // $FlowFixMe[incompatible-type]
  {
    ...
    category: 'Contributor',
    id: 'twitter-follow',
    description: 'You follow AirStudio on X/Twitter',
    descriptionByLocale: { en: 'You follow AirStudio on X/Twitter' },
    shortDescriptionByLocale: { en: 'Follow AirStudio on X (Twitter).' },
    rewardValueInCredits: 80,
    iconName: 'twitter-follow',
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/tiktok-follow.svg',
    publicDescription: "{user}Â follows AirStudio's account on X/Twitter",
    publicDescriptionByLocale: {
      en: "{user}Â follows AirStudio's account on X/Twitter",
    },
  },
  // $FlowFixMe[incompatible-type]
  {
    name: 'AirStudio Master course graduate',
    nameByLocale: {
      en: 'AirStudio Master course graduate',
    },
    category: 'Course completed',
    id: 'course-premium-course',
    description: 'Congrats on finishing the AirStudio Master course!',
    descriptionByLocale: {
      en: 'Congrats on completing the AirStudio Master course!',
    },
    shortDescriptionByLocale: {
      en: 'Complete the AirStudio Master course',
    },
    iconName: 'course-premium-course',
    iconUrl:
      'https://resources.AirStudio-app.com/badges/icons/course-premium-course.svg',
    publicDescription: '{user} completed the AirStudio Master course',
    publicDescriptionByLocale: {
      en: '{user} completed the AirStudio Master course',
    },
  },
];
