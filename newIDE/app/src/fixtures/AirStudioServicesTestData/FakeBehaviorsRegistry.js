// @flow
import { type BehaviorsRegistry } from '../../Utils/AirStudioServices/Extension';
import { type BehaviorShortHeader } from '../../Utils/AirStudioServices/Extension';
...
export const fakeBehaviorsRegistry: BehaviorsRegistry & {
  ...
  headers: [
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'Billboard',
      version: '1.0.0',
      url: 'https://resources.AirStudio-app.com/extensions/Billboard.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/Billboard-header.json',
      // $FlowFixMe[incompatible-type]
      tags: '3d',
      category: 'Visual effect',
      previewIconUrl:
        'https://asset-resources.AirStudio.io/public-resources/Icons/b46f9cf1fc6b0ef59a461c7831003d1fb091137cbedbae876774f40f8b7dea97_pine-tree.svg',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/bullet.svg',
      extensionName: 'FireBullet',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'Flash',
      version: '1.0.1',
      url: 'https://resources.AirStudio-app.com/extensions/Flash.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/Flash-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'flash,blink,visible,invisible,hit,damage',
      category: 'Visual effect',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/flash-outline.svg',
      extensionName: 'Flash',
      description:
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      version: '0.6.1',
      url: 'https://resources.AirStudio-app.com/extensions/Gamepads.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/Gamepads-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'controllers,gamepads,joysticks,axis,xbox,ps4',
      category: 'Input',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/gamepad-variant-outline.svg',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'Health',
      version: '0.3.0',
      url: 'https://resources.AirStudio-app.com/extensions/Health.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/Health-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'health,life,damage,hit,heal,shield,regeneration,armor',
      category: 'Game mechanic',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/heart-half-full.svg',
      extensionName: 'Health',
      description:
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'SmoothCamera',
      version: '0.3.0',
      url: 'https://resources.AirStudio-app.com/extensions/SmoothCamera.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/SmoothCamera-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'camera,scrolling,follow,smooth',
      category: 'Camera',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/Line Hero Pack/Master/SVG/Computers and Hardware/Computers and Hardware_camcoder_gopro_go_pro_camera.svg',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      version: '1.2.2',
      url:
        'https://resources.AirStudio-app.com/extensions/SpriteMultitouchJoystick.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/SpriteMultitouchJoystick-header.json',
      tags:
        // $FlowFixMe[incompatible-type]
        'multitouch,joystick,thumbstick,controller,touchscreen,twin stick,shooter,virtual',
      category: 'Input',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/Line Hero Pack/Master/SVG/Videogames/Videogames_controller_joystick_arrows_direction.svg',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'StayOnScreen',
      version: '1.0.1',
      url: 'https://resources.AirStudio-app.com/extensions/StayOnScreen.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/StayOnScreen-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'positioning,camera,screen',
      category: 'Movement',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/monitor-screenshot.svg',
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'YSort',
      version: '0.1.0',
      url: 'https://resources.AirStudio-app.com/extensions/YSort.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/YSort-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'z-order,y-sort,depth,fake-depth,isometric,rpg',
      category: 'Visual effect',
      previewIconUrl:
        'https://resources.AirStudio-app.com/assets/Icons/sort-ascending.svg',
      extensionName: 'YSort',
      description:
    ...
    // $FlowFixMe[incompatible-type]
    {
      ...
      name: 'RevoluteJoint',
      version: '1.0.0',
      url: 'https://resources.AirStudio-app.com/extensions/JointConnector.json',
      headerUrl:
        'https://resources.AirStudio-app.com/extensions/JointConnector-header.json',
      // $FlowFixMe[incompatible-type]
      tags: 'joint,ragdoll,physics,spring,rope,weld,revolute,distance',
      category: 'General',
      previewIconUrl:
        'https://asset-resources.AirStudio.io/public-resources/Icons/8834e0c63a962c74f1dab4c8f918c171261597341c4ca6574b300ab35855274b_human.svg',
