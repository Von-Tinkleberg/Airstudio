...
import { type Profile } from '../../Utils/AirStudioServices/Authentication';
import { type Release } from '../../Utils/AirStudioServices/Release';
import {
  type Build,
  type SigningCredential,
} from '../../Utils/AirStudioServices/Build';
import { type CloudProjectWithUserAccessInfo } from '../../Utils/AirStudioServices/Project';
import {
  type ExtensionShortHeader,
  type ExtensionHeader,
} from '../../Utils/AirStudioServices/Extension';
import { type UserPublicProfile } from '../../Utils/AirStudioServices/User';
import { type ExampleShortHeader } from '../../Utils/AirStudioServices/Example';
import {
  type Game,
  type PublicGame,
  type ShowcasedGame,
} from '../../Utils/AirStudioServices/Game';
import { type GameMetrics } from '../../Utils/AirStudioServices/Analytics';
...
import {
  ...
  type Bundle,
} from '../../Utils/AirStudioServices/Asset';
import { formatISO, subDays } from 'date-fns';
import { type Comment } from '../../Utils/AirStudioServices/Play';
import {
  type Announcement,
  type Promotion,
} from '../../Utils/AirStudioServices/Announcement';
import {
  type PrivateGameTemplateListingData,
  type PrivateAssetPackListingData,
  type BundleListingData,
} from '../../Utils/AirStudioServices/Shop';
...
export const purchaselyGoldSubscription: Subscription = {
  ...
  updatedAt: 1515084011000,
  userId: 'silver-user',
  purchaselyPlan: 'AirStudio_gold_whatever',
  pricingSystemId: 'PURCHASELY_AirStudio_gold_whatever',
};
...
export const defaultAuthenticatedUserWithNoSubscription: AuthenticatedUser = {
  ...
  recommendations: [
    {
      type: 'AirStudio-tutorial',
      id: 'playlist-get-started',
    },
    {
      type: 'AirStudio-tutorial',
      id: 'AirStudio-teaching-kids',
    },
    {
      type: 'AirStudio-tutorial',
      id: 'tween-behavior',
  ...
  receivedAssetPacks: [
    {
      ...
      longDescription: '',
      previewImageUrls: [
        'https://resources.AirStudio-app.com/staging/private-assets/Gamepasses/thumbnail.png',
      ],
      tag: 'gamepasses',
      content: {},
    },
...
export const releaseWithBreakingChange: Release = {
  ...
  url: 'https://github.com/4ian/AirStudio/releases/tag/v5.0.0-beta60',
  description:
    '> Ã¢Å¡Â Ã¯Â¸Â Blabla, beware there is a breaking change!!!\r\n\r\n## Ã¢Å“Â¨New features\r\n\r\n* **Functions** are now "out of alpha testing" and always shown in the project manager. Functions are a powerful way to create new conditions, actions and expression using events. This allow to make your events and the logic of your game easier to understand and create. This also allow you to share common functions between games and create advanced features that are easy to use. [Learn more about functions on the wiki](https://wiki.AirStudio.io/AirStudio5/events/functions)\r\n* A brand new Physics engine: **Physics Engine 2.0**. (Thanks @Lizard-13 for creating it, testing it, improving it and creating examples and tests, and @zatsme for various update and examples!). While still based on the same internal physics engine, it is much more complete and powerful than the previous one:\r\n  * Support for a lot of joints (revolute, gear, mouse, prismatic, rope, pulley, wheel and more!)\r\n  * Support more options for bodies\r\n  * Support more shape and even custom polygons for objects.\r\n  * Look at the updated and **new examples** to learn how to use it and to see what\'s possible!\r\n\r\n  > Your existing games will continue to work with the old physics engine. You can still continue to use it. For new games, prefer to use the new Physics Engine 2.0. In your existing game, you can also replace *the behavior of all of your objects* by the new behavior, and replace *all the conditions and actions* by the conditions and actions from the new engine.\r\n* New **Screenshot** action, to take in-game screenshot for games running on Windows/macOS/Linux. (thanks @Wend1go!)\r\n  * This also come with new expressions to access to the **file system paths**, useful to save the screenshots in a folder of the user.\r\n\r\n## Ã°Å¸â€™Â Improvements\r\n\r\n* Display missing files in resource editor as red (thanks @blurymind!)\r\n* Add option to set scale mode ("sampling") of the game to nearest (for "pixel perfect" or 8bit games) in the game properties.\r\n* Usability: autoclose project manager when opening an editor (thanks @blurymind!)\r\n* Add button to choose a new file for a resource in the resource editor (thanks @blurymind!)\r\n* New "Pixel perfect platform engine" example.\r\n* Usability: add shortcut to open Project Manager and focus search field when opening it.\r\n* Updated "Isometric Game" starter game to have better collision handling and mobile support.\r\n* Add GetAngle/GetXVelocity and GetYVelocity expressions to top-down movement behavior.\r\n* Extensions written in JavaScript can now be used to create new type of objects.\r\n* Usability: icons in the list of instructions or expressions are now displayed.\r\n\r\n## Ã°Å¸Ââ€º Bug fixes \r\n\r\n* Update **Facebook Instant Games export** to have the now required bundle file (fbapp-config.json).\r\n* Fix the sentence in the events sheet of a Facebook Instant Games action. (thanks @Bouh!)\r\n* Fix descriptions of Storage actions to make clear that no "real" files are written.\r\n* Fix Left Shift key\r\n* Fix middle mouse button (thanks @Bouh!)\r\n* Fix visual artifacts when rendering rescaled games\r\n* Fix platform engine 1-pixel offset bug\r\n* Fix initial opacity undefined for text objects (thanks @Lizard-13)\r\n* Fix the condition checking if the cursor is on an object (thanks @Lizard-13)\r\n* Avoid crash of the debugger with Particle Emitters\r\n* Add explicit "OK" button in message box to fix issue on Linux\r\n* Usability: hide object drop-down list after an object is selected\r\n* Fix login dialog not showing on top of export dialog',
};
...
export const fakeAsset1: Asset = {
  ...
  previewImageUrls: [
    'https://asset-resources.AirStudio.io/public-resources/Simple Space/spaceships/b0e7ae371773ea6cf1e18a7db1d32ea1b4b9dd388f1f31aed5b7c1501437292c_Complex Spaceship_Type A.png',
  ],
  animationsCount: 6,
  maxFramesCount: 6,
  height: 36,
  width: 36,
  objectType: 'sprite',
  AirStudioVersion: '5.0.0-beta100',
  version: '1.0.0',
  authors: ['test author'],
  license: 'MIT',
...
export const fakeAssetWithCustomObject: Asset = {
  ...
  objectAssets: [
    {
      ...
      resources: [
        {
          file:
            'https://resources.AirStudio-app.com/assets/Custom objects/object_YellowButton_Hovered.png',
          kind: 'image',
          metadata: '',
        ...
        {
          file:
            'https://resources.AirStudio-app.com/assets/Custom objects/object_YellowButton_Idle.png',
          kind: 'image',
          metadata: '',
        ...
        {
          file:
            'https://resources.AirStudio-app.com/assets/Custom objects/object_YellowButton_Pressed.png',
          kind: 'image',
          metadata: '',
  ...
  maxFramesCount: 1,
  previewImageUrls: [
    'https://asset-resources.AirStudio.io/public-resources/Menu buttons/3e1b2da0279f60b6a6d1cfe4c79875b70a81b0bec7aa45ff18bff03eb26326eb_Yellow Button.preview.png',
  ],
  width: 256,
  height: 106,
...
export const fakeAssetShortHeader1: AssetShortHeader = {
  ...
  objectType: 'sprite',
  previewImageUrls: [
    'https://resources.AirStudio-app.com/assets/24x24 Dino Characters/Dino Doux_Crouch.png',
  ],
...
export const fakePrivateAssetShortHeader1: AssetShortHeader = {
  ...
  objectType: 'sprite',
  previewImageUrls: ['https://private-assets.AirStudio.io/fake-preview.png'],
...
export const fireBulletExtensionShortHeader: ExtensionShortHeader = {
  ...
  name: 'FireBullet',
  version: '0.0.2',
  url: 'https://resources.AirStudio-app.com/extensions/FireBullet.json',
  headerUrl:
    'https://resources.AirStudio-app.com/extensions/FireBullet-header.json',
  tags: ['fire', 'bullets', 'spawn', 'firerate'],
  category: 'Movement',
  previewIconUrl: 'https://resources.AirStudio-app.com/assets/Icons/repeat.svg',
...
export const fireBulletExtensionHeader: ExtensionHeader = {
  ...
  iconUrl: 'https://resources.AirStudio-app.com/assets/Icons/repeat.svg',
};

export const uncompatibleFireBulletExtensionShortHeader: ExtensionShortHeader = {
  ...fireBulletExtensionShortHeader,
  AirStudioVersion: '2000.0.0',
};
...
export const communityTierExtensionShortHeader: ExtensionShortHeader = {
  ...
  version: '0.0.2',
  url:
    'https://resources.AirStudio-app.com/extensions/FakeCommunityExtension.json',
  headerUrl:
    'https://resources.AirStudio-app.com/extensions/FakeCommunityExtension-header.json',
  tags: ['fire', 'bullets', 'spawn', 'firerate'],
  category: '',
  previewIconUrl: 'https://resources.AirStudio-app.com/assets/Icons/repeat.svg',
  eventsBasedBehaviorsCount: 1,
...
export const showcasedGame1: ShowcasedGame = {
  ...
  imageUrls: [
    'https://resources.AirStudio-app.com/games-showcase/images/18JKXDTWljabX3O09SW2VKYOThZkIf1jG',
  ],
  links: [
    {
      url:
  ...
  isFeatured: false,
  bannerUrl:
    'https://resources.AirStudio-app.com/games-showcase/images/bub-game-banner.jpg',
  bannerBackgroundPosition: '',
  thumbnailUrl:
    'https://resources.AirStudio-app.com/games-showcase/images/bub-animated-logo.gif',
  editorDescription: '',
};
...
export const exampleFromFutureVersion: ExampleShortHeader = {
  ...
  slug: 'fake-slug',
  name: 'Fake example',
  shortDescription: 'This is a fake example made in a future AirStudio version',
  description: '',
  license: 'MIT',
  tags: [],
  previewImageUrls: [],
  AirStudioVersion: '99.0.0',
  codeSizeLevel: 'small',
};
...
export const geometryMonsterExampleShortHeader: ExampleShortHeader = {
  ...
  license: 'MIT',
  previewImageUrls: [
    'https://resources.AirStudio-app.com/examples/geometry-monster/thumbnail.png',
  ],
  authorIds: [],
  tags: [
    'geometry-monster',
...
export const fakePrivateGameTemplateListingData: PrivateGameTemplateListingData = {
  ...
  thumbnailUrls: [
    'https://resources.AirStudio-app.com/staging/private-assets/French Food/thumbnail1.png',
  ],
  prices: [
    {
      name: 'commercial_USD',
...
export const fakeAssetPacks: PublicAssetPacks = {
  starterPacks: [
    {
      name: 'AirStudio Platformer',
      tag: 'platformer',
      categories: ['full-game-pack'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/platformer.png',
      assetsCount: 16,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: [],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/space shooter.png',
      assetsCount: 140,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: [],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/tank pack.png',
      assetsCount: 32,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: ['full-game-pack'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/pixel adventure pack.png',
      assetsCount: 80,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: ['full-game-pack'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/pirate bomb pack.png',
      assetsCount: 48,
      authors: [],
      licenses: [],
    ...
    },
    {
      ...
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/pixel effects pack.png',
      assetsCount: 20,
      authors: [],
      licenses: [],
    },
    {
      ...
      tag: 'emote',
      categories: [],
      thumbnailUrl: 'https://resources.AirStudio-app.com/assets/Packs/emote.png',
      assetsCount: 176,
      authors: [],
      licenses: [],
    },
    {
      ...
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/24x24 dino characters.png',
      assetsCount: 5,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: ['props'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/16x16 pixel art spinning items.png',
      assetsCount: 30,
      authors: [],
      licenses: [],
      userFriendlyPrice: '$4.99',
    },
    {
      ...
      categories: ['props'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/16x16 pixel art rpg items.png',
      assetsCount: 64,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: ['props'],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/16x16 rpg item pack.png',
      assetsCount: 144,
      authors: [],
      licenses: [],
    },
    {
      ...
      categories: [],
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/32x32 fantasy icons pack v2.png',
      assetsCount: 285,
      authors: [],
      licenses: [],
    },
    {
      ...
      thumbnailUrl:
        'https://resources.AirStudio-app.com/assets/Packs/on-screen controls.png',
      assetsCount: 287,
      authors: [],
      licenses: [],
    },
...
export const fakePrivateAssetPack2ListingData: PrivateAssetPackListingData = {
  ...
  productType: 'ASSET_PACK',
  thumbnailUrls: [
    'https://resources.AirStudio-app.com/staging/private-assets/French Sounds/thumbnail0.png',
  ],
  updatedAt: '2022-09-14T12:43:51.329Z',
  createdAt: '2022-09-14T12:43:51.329Z',
  listing: 'ASSET_PACK',
...
export const fakeBundle: Bundle = {
  ...
  categories: ['starter'],
  previewImageUrls: [
    'https://resources.AirStudio-app.com/assets/Packs/AirStudio platformer.png',
    'https://resources.AirStudio-app.com/assets/Packs/space shooter.png',
    'https://resources.AirStudio-app.com/assets/Packs/particles emitter.png',
  ],
...
export const fakeAnnouncements: Announcement[] = [
  {
    ...
    markdownMessageByLocale: {
      en:
        'Something to announce which is really really cool [with a link](https://AirStudio.io) and *other* **markdown** ~~formatting~~!',
    },
  },
  {
    id: '124',
    ...
    markdownMessageByLocale: {
      en:
        'Something nothing important but urgent to announce, with a button and [with a link](https://AirStudio.io) too.',
    },
    buttonLabelByLocale: { en: 'View' },
    buttonUrl: 'https://AirStudio.io',
  },
  {
    id: '125',
    type: 'warning',
  ...
  },
  {
    ...
    markdownMessageByLocale: {
      en:
        'Something important but not urgent to announce, with a big image.\n\n![some image](https://raw.githubusercontent.com/4ian/AirStudio/master/newIDE/AirStudio%20banner.png)',
    },
    buttonLabelByLocale: { en: 'View' },
    buttonUrl: 'https://AirStudio.io',
  },
  {
    ...
    markdownMessageByLocale: {
      en:
        '[![AirStudio Mega pack](https://resources.AirStudio.io/announcements/AirStudios_Mega_Pack_Updated.png)](https://play.google.com/store/apps/details?id=io.AirStudio.ide)',
    },
    mobileMarkdownMessageByLocale: {
      en:
        '[![AirStudio Mega pack](https://resources.AirStudio.io/announcements/AirStudios_Mega_Pack_Mobile.jpg)](https://play.google.com/store/apps/details?id=io.AirStudio.ide)',
    },
  },
];
...
export const fakePromotions: Promotion[] = [
  {
    id: 'AirStudio-mega-pack',
    imageUrl:
      'https://resources.AirStudio.io/announcements/AirStudios_Mega_Pack_Updated.png',
    mobileImageUrl:
      'https://resources.AirStudio.io/announcements/AirStudios_Mega_Pack_Mobile.jpg',
  ...
  },
  {
    ...
    imageUrl:
      'https://resources.AirStudio.io/announcements/AirStudio_Quiz_Template.png',
    mobileImageUrl:
      'https://resources.AirStudio.io/announcements/AirStudio_Quiz_Template_Mobile.jpg',
    linkUrl: 'https://gd.games/AirStudio',
    display: 'all',
    type: 'game',
  },
  {
    id: 'AirStudio-produce-farm-bundle',
    imageUrl:
      'https://resources.AirStudio.io/announcements/AirStudio_Produce_Farm_Bundle.png',
    mobileImageUrl:
      'https://resources.AirStudio.io/announcements/Produce_Farm_Bundle_Mobile.jpg',
...
export const basicFeaturingMarketingPlan = {
  ...
  descriptionByLocale: {
    ...
    'ar-SA': 'Ã™â€¦Ã˜Â«Ã˜Â§Ã™â€žÃ™Å  Ã™â€žÃ˜Â§Ã˜Â®Ã˜ÂªÃ˜Â¨Ã˜Â§Ã˜Â± Ã˜Â¥Ã˜ÂµÃ˜Â¯Ã˜Â§Ã˜Â± Ã˜Â£Ã™â€žÃ™ÂÃ˜Â§ Ã˜Â§Ã™â€žÃ˜Â®Ã˜Â§Ã˜Âµ Ã˜Â¨Ã™Æ’ Ã™Ë†Ã˜Â¬Ã™â€¦Ã˜Â¹ Ã˜Â§Ã™â€žÃ™â€¦Ã˜Â¹Ã™â€žÃ™Ë†Ã™â€¦Ã˜Â§Ã˜Âª.',
    'de-DE':
      'Perfekt, um Ihren Alpha-Build zu testen und Informationen zu sammeln.',
    'es-ES': 'Perfecto para probar su versiÃƒÂ³n alfa y recopilar informaciÃƒÂ³n.',
    'it-IT':
      'Perfetto per testare la tua versione alpha e raccogliere informazioni.',
    'ja-JP': 'Ã£â€šÂ¢Ã£Æ’Â«Ã£Æ’â€¢Ã£â€šÂ¡Ã£Æ’â€œÃ£Æ’Â«Ã£Æ’â€°Ã£â€šâ€™Ã£Æ’â€ Ã£â€šÂ¹Ã£Æ’Ë†Ã£Ââ€”Ã£ÂÂ¦Ã¦Æ’â€¦Ã¥Â Â±Ã£â€šâ€™Ã¥ÂÅ½Ã©â€ºâ€ Ã£Ââ„¢Ã£â€šâ€¹Ã£ÂÂ®Ã£ÂÂ«Ã¦Å“â‚¬Ã©ÂÂ©Ã£ÂÂ§Ã£Ââ„¢Ã£â‚¬â€š',
    'ko-KR': 'Ã¬â€¢Å’Ã­Å’Å’ Ã«Â¹Å’Ã«â€œÅ“Ã«Â¥Â¼ Ã­â€¦Å’Ã¬Å Â¤Ã­Å Â¸Ã­â€¢ËœÃªÂ³Â  Ã¬Â â€¢Ã«Â³Â´Ã«Â¥Â¼ Ã¬Ë†ËœÃ¬Â§â€˜Ã­â€¢ËœÃªÂ¸Â°Ã¬â€”Â Ã¬ÂÂ´Ã¬Æ’ÂÃ¬Â ÂÃ¬Å¾â€¦Ã«â€¹Ë†Ã«â€¹Â¤.',
    'pl-PL': 'Idealny do przetestowania wersji alfa i zbierania informacji.',
    'pt-BR': 'Perfeito para testar sua versÃƒÂ£o alfa e coletar informaÃƒÂ§ÃƒÂµes.',
    'ru-RU':
      'ÃËœÃÂ´ÃÂµÃÂ°ÃÂ»Ã‘Å’ÃÂ½ÃÂ¾ ÃÂ¿ÃÂ¾ÃÂ´Ã‘â€¦ÃÂ¾ÃÂ´ÃÂ¸Ã‘â€š ÃÂ´ÃÂ»Ã‘Â Ã‘â€šÃÂµÃ‘ÂÃ‘â€šÃÂ¸Ã‘â‚¬ÃÂ¾ÃÂ²ÃÂ°ÃÂ½ÃÂ¸Ã‘Â ÃÂ°ÃÂ»Ã‘Å’Ã‘â€žÃÂ°-ÃÂ²ÃÂµÃ‘â‚¬Ã‘ÂÃÂ¸ÃÂ¸ ÃÂ¸ Ã‘ÂÃÂ±ÃÂ¾Ã‘â‚¬ÃÂ° ÃÂ¸ÃÂ½Ã‘â€žÃÂ¾Ã‘â‚¬ÃÂ¼ÃÂ°Ã‘â€ ÃÂ¸ÃÂ¸.',
    'sl-SI': 'Popolno za testiranje alfa razliÃ„Âice in zbiranje informacij.',
    'uk-UA':
      'Ãâ€ ÃÂ´ÃÂµÃÂ°ÃÂ»Ã‘Å’ÃÂ½ÃÂ¾ ÃÂ¿Ã‘â€“ÃÂ´Ã‘â€¦ÃÂ¾ÃÂ´ÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ´ÃÂ»Ã‘Â Ã‘â€šÃÂµÃ‘ÂÃ‘â€šÃ‘Æ’ÃÂ²ÃÂ°ÃÂ½ÃÂ½Ã‘Â ÃÂ°ÃÂ»Ã‘Å’Ã‘â€žÃÂ°-ÃÂ²ÃÂµÃ‘â‚¬Ã‘ÂÃ‘â€“Ã‘â€” Ã‘â€šÃÂ° ÃÂ·ÃÂ±ÃÂ¾Ã‘â‚¬Ã‘Æ’ Ã‘â€“ÃÂ½Ã‘â€žÃÂ¾Ã‘â‚¬ÃÂ¼ÃÂ°Ã‘â€ Ã‘â€“Ã‘â€”.',
    'zh-CN': 'Ã¥Â®Å’Ã§Â¾Å½Ã§Å¡â€žÃ¦Âµâ€¹Ã¨Â¯â€¢Ã¦â€šÂ¨Ã§Å¡â€žalphaÃ§â€°Ë†Ã¦Å“Â¬Ã¥Â¹Â¶Ã¦â€Â¶Ã©â€ºâ€ Ã¤Â¿Â¡Ã¦ÂÂ¯Ã£â‚¬â€š',
  },
  bulletPointsByLocale: [
    {
      en: 'Be promoted on gd.games homepage for 7 days',
      'fr-FR':
        "ÃƒÅ tre mis en avant sur la page d'accueil de gd.games pendant 7 jours",
      'ar-SA': 'Ã™Å Ã˜ÂªÃ™â€¦ Ã˜Â¹Ã˜Â±Ã˜Â¶Ã™â€¡ Ã˜Â¹Ã™â€žÃ™â€° Ã˜Â§Ã™â€žÃ˜ÂµÃ™ÂÃ˜Â­Ã˜Â© Ã˜Â§Ã™â€žÃ˜Â±Ã˜Â¦Ã™Å Ã˜Â³Ã™Å Ã˜Â© Ã™â€žÃ™â‚¬ gd.games Ã™â€žÃ™â€¦Ã˜Â¯Ã˜Â© 7 Ã˜Â£Ã™Å Ã˜Â§Ã™â€¦',
      'de-DE': '7 Tage lang auf der Startseite von gd.games vorgestellt werden',
      'es-ES': 'Destacado en la pÃƒÂ¡gina de inicio de gd.games durante 7 dÃƒÂ­as',
      'it-IT': 'In primo piano sulla homepage di gd.games per 7 giorni',
      'ja-JP': 'gd.gamesÃ£ÂÂ®Ã£Æ’â€ºÃ£Æ’Â¼Ã£Æ’Â Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸Ã£ÂÂ§7Ã¦â€”Â¥Ã©â€“â€œÃ§Â´Â¹Ã¤Â»â€¹Ã£Ââ€¢Ã£â€šÅ’Ã£ÂÂ¾Ã£Ââ„¢',
      'ko-KR': 'gd.gamesÃ¬ÂËœ Ã­â„¢Ë†Ã­Å½ËœÃ¬ÂÂ´Ã¬Â§â‚¬Ã¬â€”ÂÃ¬â€žÅ“ 7 Ã¬ÂÂ¼ Ã«Ââ„¢Ã¬â€¢Ë† Ã¬â€ Å’ÃªÂ°Å“Ã«ÂÂ©Ã«â€¹Ë†Ã«â€¹Â¤.',
      'pl-PL': 'ZostaÃ…â€ž wyrÃƒÂ³Ã…Â¼niony na stronie gÃ…â€šÃƒÂ³wnej gd.games przez 7 dni',
      'pt-BR': 'Destaque na pÃƒÂ¡gina inicial do gd.games por 7 dias',
      'ru-RU': 'ÃÂ ÃÂµÃÂºÃÂ¾ÃÂ¼ÃÂµÃÂ½ÃÂ´Ã‘Æ’ÃÂµÃ‘â€šÃ‘ÂÃ‘Â ÃÂ½ÃÂ° ÃÂ³ÃÂ»ÃÂ°ÃÂ²ÃÂ½ÃÂ¾ÃÂ¹ Ã‘ÂÃ‘â€šÃ‘â‚¬ÃÂ°ÃÂ½ÃÂ¸Ã‘â€ ÃÂµ gd.games ÃÂ² Ã‘â€šÃÂµÃ‘â€¡ÃÂµÃÂ½ÃÂ¸ÃÂµ 7 ÃÂ´ÃÂ½ÃÂµÃÂ¹',
      'sl-SI': 'Prikazano na zaÃ„Âetni strani gd.games 7 dni',
      'uk-UA': 'ÃÂ ÃÂµÃÂºÃÂ¾ÃÂ¼ÃÂµÃÂ½ÃÂ´Ã‘Æ’Ã‘â€Ã‘â€šÃ‘Å’Ã‘ÂÃ‘Â ÃÂ½ÃÂ° ÃÂ³ÃÂ¾ÃÂ»ÃÂ¾ÃÂ²ÃÂ½Ã‘â€“ÃÂ¹ Ã‘ÂÃ‘â€šÃÂ¾Ã‘â‚¬Ã‘â€“ÃÂ½Ã‘â€ Ã‘â€“ gd.games ÃÂ¿Ã‘â‚¬ÃÂ¾Ã‘â€šÃ‘ÂÃÂ³ÃÂ¾ÃÂ¼ 7 ÃÂ´ÃÂ½Ã‘â€“ÃÂ²',
      'zh-CN': 'Ã¥Å“Â¨gd.gamesÃ©Â¦â€“Ã©Â¡ÂµÃ¤Â¸Å Ã¦Å½Â¨Ã¥Â¹Â¿7Ã¥Â¤Â©',
    },
    {
      en: 'Get more player feedback',
      'fr-FR': 'Obtenez plus de commentaires de joueurs',
      'ar-SA': 'Ã˜Â§Ã˜Â­Ã˜ÂµÃ™â€ž Ã˜Â¹Ã™â€žÃ™â€° Ã™â€¦Ã˜Â²Ã™Å Ã˜Â¯ Ã™â€¦Ã™â€  Ã˜ÂªÃ˜Â¹Ã™â€žÃ™Å Ã™â€šÃ˜Â§Ã˜Âª Ã˜Â§Ã™â€žÃ™â€žÃ˜Â§Ã˜Â¹Ã˜Â¨Ã™Å Ã™â€ ',
      'de-DE': 'Mehr Spieler-Feedback erhalten',
      'es-ES': 'Obtenga mÃƒÂ¡s comentarios de los jugadores',
      'it-IT': 'Ottieni piÃƒÂ¹ feedback dai giocatori',
      'ja-JP': 'Ã£â€šË†Ã£â€šÅ Ã¥Â¤Å¡Ã£ÂÂÃ£ÂÂ®Ã£Æ’â€”Ã£Æ’Â¬Ã£â€šÂ¤Ã£Æ’Â¤Ã£Æ’Â¼Ã£Æ’â€¢Ã£â€šÂ£Ã£Æ’Â¼Ã£Æ’â€°Ã£Æ’ÂÃ£Æ’Æ’Ã£â€šÂ¯Ã£â€šâ€™Ã¥Ââ€“Ã¥Â¾â€”Ã£Ââ„¢Ã£â€šâ€¹',
      'ko-KR': 'Ã«Ââ€ Ã«Â§Å½Ã¬Ââ‚¬ Ã­â€Å’Ã«Â Ë†Ã¬ÂÂ´Ã¬â€“Â´ Ã­â€Â¼Ã«â€œÅ“Ã«Â°Â± Ã«Â°â€ºÃªÂ¸Â°',
      'pl-PL': 'Otrzymaj wiÃ„â„¢cej opinii graczy',
      'pt-BR': 'Obtenha mais feedback dos jogadores',
      'ru-RU': 'ÃÅ¸ÃÂ¾ÃÂ»Ã‘Æ’Ã‘â€¡ÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ±ÃÂ¾ÃÂ»Ã‘Å’Ã‘Ë†ÃÂµ ÃÂ¾Ã‘â€šÃÂ·Ã‘â€¹ÃÂ²ÃÂ¾ÃÂ² ÃÂ¸ÃÂ³Ã‘â‚¬ÃÂ¾ÃÂºÃÂ¾ÃÂ²',
      'sl-SI': 'Pridobite veÃ„Â povratnih informacij igralcev',
      'uk-UA': 'ÃÅ¾Ã‘â€šÃ‘â‚¬ÃÂ¸ÃÂ¼ÃÂ°Ã‘â€šÃÂ¸ ÃÂ±Ã‘â€“ÃÂ»Ã‘Å’Ã‘Ë†ÃÂµ ÃÂ²Ã‘â€“ÃÂ´ÃÂ³Ã‘Æ’ÃÂºÃ‘â€“ÃÂ² ÃÂ³Ã‘â‚¬ÃÂ°ÃÂ²Ã‘â€ Ã‘â€“ÃÂ²',
      'zh-CN': 'Ã¨Å½Â·Ã¥Â¾â€”Ã¦â€ºÂ´Ã¥Â¤Å¡Ã§Å½Â©Ã¥Â®Â¶Ã¥ÂÂÃ©Â¦Ë†',
    },
  ],
  additionalSuccessMessageByLocale: {
    ...
    'fr-FR':
      'Assurez-vous que votre jeu est public et que vous avez configurÃƒÂ© une miniature pour gd.games. Il peut falloir quelques minutes pour que votre jeu soit visible sur la plateforme.',
    'ar-SA':
      'Ã˜ÂªÃ˜Â£Ã™Æ’Ã˜Â¯ Ã™â€¦Ã™â€  Ã˜Â£Ã™â€  Ã™â€žÃ˜Â¹Ã˜Â¨Ã˜ÂªÃ™Æ’ Ã˜Â¹Ã˜Â§Ã™â€¦Ã˜Â© Ã™Ë†Ã˜Â£Ã™â€ Ã™Æ’ Ã™â€šÃ™â€¦Ã˜Âª Ã˜Â¨Ã˜ÂªÃ™Æ’Ã™Ë†Ã™Å Ã™â€  Ã˜ÂµÃ™Ë†Ã˜Â±Ã˜Â© Ã™â€¦Ã˜ÂµÃ˜ÂºÃ˜Â±Ã˜Â© Ã™â€žÃ™â‚¬ gd.games. Ã™â€šÃ˜Â¯ Ã™Å Ã˜Â³Ã˜ÂªÃ˜ÂºÃ˜Â±Ã™â€š Ã˜Â¨Ã˜Â¶Ã˜Â¹ Ã˜Â¯Ã™â€šÃ˜Â§Ã˜Â¦Ã™â€š Ã˜Â­Ã˜ÂªÃ™â€° Ã˜ÂªÃ˜Â¸Ã™â€¡Ã˜Â± Ã™â€žÃ˜Â¹Ã˜Â¨Ã˜ÂªÃ™Æ’ Ã˜Â¹Ã™â€žÃ™â€° Ã˜Â§Ã™â€žÃ™â€¦Ã™â€ Ã˜ÂµÃ˜Â©.',
    'de-DE':
      'Stellen Sie sicher, dass Ihr Spiel ÃƒÂ¶ffentlich ist und Sie ein Miniaturbild fÃƒÂ¼r gd.games konfiguriert haben. Es kann einige Minuten dauern, bis Ihr Spiel auf der Plattform sichtbar ist.',
    'es-ES':
      'AsegÃƒÂºrate de que tu juego es pÃƒÂºblico y has configurado una miniatura para gd.games. Puede tardar unos minutos en que tu juego sea visible en la plataforma.',
    'it-IT':
      'Assicurati che il tuo gioco sia pubblico e che tu abbia configurato unÃ¢â‚¬â„¢anteprima per gd.games. Potrebbero essere necessari alcuni minuti affinchÃƒÂ© il tuo gioco sia visibile sulla piattaforma.',
    'ja-JP':
      'Ã£â€šÂ²Ã£Æ’Â¼Ã£Æ’Â Ã£ÂÅ’Ã¥â€¦Â¬Ã©â€“â€¹Ã£Ââ€¢Ã£â€šÅ’Ã£ÂÂ¦Ã£ÂÅ Ã£â€šÅ Ã£â‚¬Âgd.gamesÃ£ÂÂ®Ã£â€šÂµÃ£Æ’Â Ã£Æ’ÂÃ£â€šÂ¤Ã£Æ’Â«Ã£ÂÅ’Ã¨Â¨Â­Ã¥Â®Å¡Ã£Ââ€¢Ã£â€šÅ’Ã£ÂÂ¦Ã£Ââ€žÃ£â€šâ€¹Ã£Ââ€œÃ£ÂÂ¨Ã£â€šâ€™Ã§Â¢ÂºÃ¨ÂªÂÃ£Ââ€”Ã£ÂÂ¦Ã£ÂÂÃ£ÂÂ Ã£Ââ€¢Ã£Ââ€žÃ£â‚¬â€šÃ£â€šÂ²Ã£Æ’Â¼Ã£Æ’Â Ã£ÂÅ’Ã£Æ’â€”Ã£Æ’Â©Ã£Æ’Æ’Ã£Æ’Ë†Ã£Æ’â€¢Ã£â€šÂ©Ã£Æ’Â¼Ã£Æ’Â Ã¤Â¸Å Ã£ÂÂ§Ã¨Â¡Â¨Ã§Â¤ÂºÃ£Ââ€¢Ã£â€šÅ’Ã£â€šâ€¹Ã£ÂÂ¾Ã£ÂÂ§Ã¦â€¢Â°Ã¥Ë†â€ Ã£Ââ€¹Ã£Ââ€¹Ã£â€šâ€¹Ã¥Â Â´Ã¥ÂË†Ã£ÂÅ’Ã£Ââ€šÃ£â€šÅ Ã£ÂÂ¾Ã£Ââ„¢Ã£â‚¬â€š',
    'ko-KR':
      'ÃªÂ²Å’Ã¬Å¾â€žÃ¬ÂÂ´ ÃªÂ³ÂµÃªÂ°Å“Ã«ÂËœÃ¬â€“Â´ Ã¬Å¾Ë†ÃªÂ³Â  gd.gamesÃ¬â€”Â Ã«Å’â‚¬Ã­â€¢Å“ Ã¬ÂÂ¸Ã«â€žÂ¤Ã¬ÂÂ¼Ã¬ÂÂ´ ÃªÂµÂ¬Ã¬â€žÂ±Ã«ÂËœÃ¬â€“Â´ Ã¬Å¾Ë†Ã«Å â€Ã¬Â§â‚¬ Ã­â„¢â€¢Ã¬ÂÂ¸Ã­â€¢ËœÃ¬â€¹Â­Ã¬â€¹Å“Ã¬ËœÂ¤. ÃªÂ²Å’Ã¬Å¾â€žÃ¬ÂÂ´ Ã­â€Å’Ã«Å¾Â«Ã­ÂÂ¼Ã¬â€”ÂÃ¬â€žÅ“ Ã«Â³Â´Ã¬ÂÂ´Ã«Å â€ Ã«ÂÂ° Ã«Âªâ€¡ Ã«Â¶â€ž Ã¬Â â€¢Ã«Ââ€ž ÃªÂ±Â¸Ã«Â¦Â´ Ã¬Ë†Ëœ Ã¬Å¾Ë†Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤.',
    'pl-PL':
      'Upewnij siÃ„â„¢, Ã…Â¼e twoja gra jest publiczna i masz skonfigurowany miniaturÃ„â„¢ dla gd.games. MoÃ…Â¼e minÃ„â€¦Ã„â€¡ kilka minut, zanim twoja gra bÃ„â„¢dzie widoczna na platformie.',
    'pt-BR':
      'Certifique-se de que seu jogo ÃƒÂ© pÃƒÂºblico e vocÃƒÂª configurou uma miniatura para o gd.games. Pode levar alguns minutos para que seu jogo seja visÃƒÂ­vel na plataforma.',
    'ru-RU':
      'ÃÂ£ÃÂ±ÃÂµÃÂ´ÃÂ¸Ã‘â€šÃÂµÃ‘ÂÃ‘Å’, Ã‘â€¡Ã‘â€šÃÂ¾ ÃÂ²ÃÂ°Ã‘Ë†ÃÂ° ÃÂ¸ÃÂ³Ã‘â‚¬ÃÂ° Ã‘ÂÃÂ²ÃÂ»Ã‘ÂÃÂµÃ‘â€šÃ‘ÂÃ‘Â ÃÂ¾ÃÂ±Ã‘â€°ÃÂµÃÂ´ÃÂ¾Ã‘ÂÃ‘â€šÃ‘Æ’ÃÂ¿ÃÂ½ÃÂ¾ÃÂ¹ ÃÂ¸ ÃÂ²Ã‘â€¹ ÃÂ½ÃÂ°Ã‘ÂÃ‘â€šÃ‘â‚¬ÃÂ¾ÃÂ¸ÃÂ»ÃÂ¸ ÃÂ¼ÃÂ¸ÃÂ½ÃÂ¸ÃÂ°Ã‘â€šÃ‘Å½Ã‘â‚¬Ã‘Æ’ ÃÂ´ÃÂ»Ã‘Â gd.games. ÃÂ­Ã‘â€šÃÂ¾ ÃÂ¼ÃÂ¾ÃÂ¶ÃÂµÃ‘â€š ÃÂ·ÃÂ°ÃÂ½Ã‘ÂÃ‘â€šÃ‘Å’ ÃÂ½ÃÂµÃ‘ÂÃÂºÃÂ¾ÃÂ»Ã‘Å’ÃÂºÃÂ¾ ÃÂ¼ÃÂ¸ÃÂ½Ã‘Æ’Ã‘â€š, Ã‘â€¡Ã‘â€šÃÂ¾ÃÂ±Ã‘â€¹ ÃÂ²ÃÂ°Ã‘Ë†ÃÂ° ÃÂ¸ÃÂ³Ã‘â‚¬ÃÂ° Ã‘ÂÃ‘â€šÃÂ°ÃÂ»ÃÂ° ÃÂ²ÃÂ¸ÃÂ´ÃÂ¸ÃÂ¼ÃÂ¾ÃÂ¹ ÃÂ½ÃÂ° ÃÂ¿ÃÂ»ÃÂ°Ã‘â€šÃ‘â€žÃÂ¾Ã‘â‚¬ÃÂ¼ÃÂµ.',
    'sl-SI':
      'PrepriÃ„Âajte se, da je vaÃ…Â¡a igra javna in da ste konfigurirali sliÃ„Âico za gd.games. Za vaÃ…Â¡o igro lahko traja nekaj minut, da bo vidna na platformi.',
    'uk-UA':
      'ÃÅ¸ÃÂµÃ‘â‚¬ÃÂµÃÂºÃÂ¾ÃÂ½ÃÂ°ÃÂ¹Ã‘â€šÃÂµÃ‘ÂÃ‘Â, Ã‘â€°ÃÂ¾ ÃÂ²ÃÂ°Ã‘Ë†ÃÂ° ÃÂ³Ã‘â‚¬ÃÂ° Ã‘â€ ÃÂ¿Ã‘Æ’ÃÂ±ÃÂ»Ã‘â€“Ã‘â€¡ÃÂ½ÃÂ¾Ã‘Å½, Ã‘â€“ ÃÂ²ÃÂ¸ ÃÂ½ÃÂ°ÃÂ»ÃÂ°Ã‘Ë†Ã‘â€šÃ‘Æ’ÃÂ²ÃÂ°ÃÂ»ÃÂ¸ ÃÂ¼Ã‘â€“ÃÂ½Ã‘â€“ÃÂ°Ã‘â€šÃ‘Å½Ã‘â‚¬Ã‘Æ’ ÃÂ´ÃÂ»Ã‘Â gd.games. ÃÂ¦ÃÂµ ÃÂ¼ÃÂ¾ÃÂ¶ÃÂµ ÃÂ·ÃÂ°ÃÂ¹ÃÂ½Ã‘ÂÃ‘â€šÃÂ¸ ÃÂºÃ‘â€“ÃÂ»Ã‘Å’ÃÂºÃÂ° Ã‘â€¦ÃÂ²ÃÂ¸ÃÂ»ÃÂ¸ÃÂ½, Ã‘â€°ÃÂ¾ÃÂ± ÃÂ²ÃÂ°Ã‘Ë†ÃÂ° ÃÂ³Ã‘â‚¬ÃÂ° Ã‘ÂÃ‘â€šÃÂ°ÃÂ»ÃÂ° ÃÂ²ÃÂ¸ÃÂ´ÃÂ¸ÃÂ¼ÃÂ¾Ã‘Å½ ÃÂ½ÃÂ° ÃÂ¿ÃÂ»ÃÂ°Ã‘â€šÃ‘â€žÃÂ¾Ã‘â‚¬ÃÂ¼Ã‘â€“.',
    'zh-CN':
      'Ã§Â¡Â®Ã¤Â¿ÂÃ¦â€šÂ¨Ã§Å¡â€žÃ¦Â¸Â¸Ã¦Ë†ÂÃ¦ËœÂ¯Ã¥â€¦Â¬Ã¥Â¼â‚¬Ã§Å¡â€žÃ¯Â¼Å’Ã¥Â¹Â¶Ã¤Â¸â€Ã¦â€šÂ¨Ã¥Â·Â²Ã§Â»ÂÃ¤Â¸Âºgd.gamesÃ©â€¦ÂÃ§Â½Â®Ã¤Âºâ€ Ã§Â¼Â©Ã§â€¢Â¥Ã¥â€ºÂ¾Ã£â‚¬â€šÃ¦â€šÂ¨Ã§Å¡â€žÃ¦Â¸Â¸Ã¦Ë†ÂÃ¥Å“Â¨Ã¥Â¹Â³Ã¥ÂÂ°Ã¤Â¸Å Ã¥ÂÂ¯Ã¨Â§ÂÃ¥ÂÂ¯Ã¨Æ’Â½Ã©Å“â‚¬Ã¨Â¦ÂÃ¥â€¡Â Ã¥Ë†â€ Ã©â€™Å¸Ã£â‚¬â€š',
  },
};
  ...
  tasks: [
    {
      ...
      text:
        'Complete the six tasks below by dragging the premade objects from the object list in to the sceneÃ¢â‚¬â„¢s default view window to match the image of the scene shown below.',
      imageUrls: [
        'https://public-resources.AirStudio.io/staging/course/images/6900ffbe-4a0e-4f1c-9ad8-b9aa495daf17.png',
      ],
    },
    {
      ...
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/40c07f00-8c66-4b6c-b092-fa4a8e00a3d6.png',
        ],
      },
    },
    {
      ...
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/22338211-c869-45d2-9d15-0868d9588142.png',
        ],
      },
    },
    {
      ...
      hint:
        '(A panel sprite(9 patch) is used for text boxes and any UI elements with repeating patterns and a rectangular border. TheyÃ¢â‚¬â„¢re called 9-patch because images are broken into 9 Ã¢â‚¬Å“patchesÃ¢â‚¬Â that have different rules applied to them when the object is stretched.)',
      imageUrls: [
        'https://public-resources.AirStudio.io/staging/course/images/74933b88-cbd9-4690-87e4-b3dfe583a93e.png',
      ],
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/ffb596da-2200-45f4-ad14-de2c0929f3ab.png',
        ],
      },
    },
    {
      ...
      text:
        'Open the Text object, change the objectÃ¢â‚¬â„¢s font to **CantoraOne-Regular from the drop down menu**, set the color to white, adjust the font size, and change the text to match the image above.\n\nDrag the **Text** object into the game scene from the object list to match the position in the image above.\n\n',
      hint:
        '(There are three different types of text objects in the engine, each serving a different purpose, and they can all have their text changed while the game is running with the use of events. Which youÃ¢â‚¬â„¢ll learn more about in later chapters.)',
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/a73da7b8-dc84-4130-917e-7341ed263f5a.png',
        ],
      },
    },
    {
      ...
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/01138252-6128-459c-9cce-c5b728d46479.png',
        ],
      },
    },
    {
      ...
      text:
        'Open the Resource_Bar object, change itÃ¢â‚¬â„¢s initial value to 4 and the maximum value to 5, and then scroll down to the bottom and change the default width of its background to 450, so the object will match the size and value of the object in the image above when you preview the game.\n\nDrag the **Resource_Bar** object into the game scene from the object list to match the position of the object in the image above.\n\nThen in the effects tab inside of the object, add the Ã¢â‚¬Å“Drop ShadowÃ¢â‚¬Â effect and set its color to black with the color picker tool, or change the Ã¢â‚¬Å“Color of the shadowÃ¢â‚¬Â text field to 0;0;0.\n\n',
      hint:
      ...
      imageUrls: [
        'https://public-resources.AirStudio.io/staging/course/images/0c7a1d3b-b2ca-45ad-a832-d51649a5b08d.png',
      ],
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/46aab784-344b-46bb-bd04-3017036a010f.png',
          'https://public-resources.AirStudio.io/staging/course/images/48e8ea8b-8fcd-45c3-8a5e-5b4f43cc8461.png',
          'https://public-resources.AirStudio.io/staging/course/images/6ef17077-50f7-46b6-8c03-17dd797d7ffe.png',
        ],
      },
    },
    {
      ...
      text:
        'When placing new instances of objects into the game scene, their z-order is automatically set to 1 higher than the instance with the highest z-order in the scene.\n\nTo see object z-order in action, open the properties panel, select the background Tiled_Sprite object, and increase its z-order in the properties one at a time to see it rise above the other objects in the scene. (You can lower itÃ¢â‚¬â„¢s Z-Order again after trying this.)\n\n',
      hint:
      ...
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/f699f117-23e5-4856-9412-5cad48573a60.png',
        ],
      },
    },
    {
      ...
      text:
        'Switch to the **PointsAndCollisions** game scene from the project manager, preview the game, and observe how this sceneÃ¢â‚¬â„¢s logic is currently set up for the **Circle** sprite object to follow the cursor whenever the left mouse button or touch is held. \n\nBy default, the Circle object will not be centered on that point because the action positions the object based on its [origin point](https://wiki.AirStudio.io/AirStudio5/objects/sprite/edit-points/), which is located at the top-left of the image.\n\nOpen the Circle object and, through the button in the bottom left corner, change the Circle objectÃ¢â‚¬â„¢s origin point to be centered in the middle of the image. Then preview the game again to see that the Circle sprite object is now centered on the cursor or point of touch.\n\n',
      hint:
        '(Take note that this doesnÃ¢â‚¬â„¢t need to be done for every object in your game; typically, you only change an objectÃ¢â‚¬â„¢s origin point when it is required for positioning, rotation, or z-ordering based on the origin pointÃ¢â‚¬â„¢s position.)',
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/7a74918f-ebab-4ff2-9263-5628565747fc.png',
          'https://public-resources.AirStudio.io/staging/course/images/17acd5ef-246e-4137-a104-dde205c9dc50.png',
        ],
      },
    },
    {
      ...
      text:
        'Place the **Collision** object into the game scene and, while previewing the game, move the **Circle** object so it touches the Collision object. The Circle objectÃ¢â‚¬â„¢s animation will change when the collision occurs, but the collision happens before the images appear to overlap.\n\nOpen both the Circle and Collision objects and, through the button in the bottom left corner, adjust the collision masks of both objects so they roughly match their images.(You can add a new point(Vertex) with the Ã¢â‚¬Å“Add a vertexÃ¢â‚¬Â button.)\n\nThen preview the game again to see how the collision detection has become more accurate.\n\n',
      hint:
      ...
      answer: {
        imageUrls: [
          'https://public-resources.AirStudio.io/staging/course/images/8e0a7b37-d8f9-448c-9eeb-9d73eac97b07.png',
          'https://public-resources.AirStudio.io/staging/course/images/547562c4-4c7e-47fd-bf04-0710fd1a4f57.png',
        ],
      },
    },
  ],
  templateUrl:
    'https://resources.AirStudio-app.com/tutorial/templates/chapter1/game.json',
...
export const textBasedCourseChapter: TextBasedCourseChapter = {
  ...
  items: [
    ...
    },
    {
      type: 'text',
      text:
        "Throughout this course, we'll explore the fundamental concepts of UI and UX design, breaking down complex theory and topics into practical easy-to-apply guidelines. YouÃ¢â‚¬â„¢ll also receive practical tools and data bases available online for free to enhance your game development process.",
    },
    {
      type: 'text',
      text:
    ...
    },
    {
      type: 'text',
      text:
        '- **What is the role of UI and UX to make good games?**\n\n  A game UI is made up game assets and sprites; while game mechanics, game play and level of difficulty are UX. Imagine a game without game art and without sounds. You will probably be clicking buttons without any feedback on your progress. That wouldnÃ¢â‚¬â„¢t be fun.\n\n  However, with beautiful art and animations (UI), good sound design, motivating game progression and feedback on your progress (UX), what could be Ã¢â‚¬Å“just clicking buttonsÃ¢â‚¬Â becomes fun and exciting!  This is why video-games are the perfect example of UI/UX!',
    },
    {
      type: 'image',
      url:
        'https://public-resources.AirStudio.io/staging/course/images/0426867a-ae95-485a-885d-16a46bb9886f.png',
    ...
    },
    {
      type: 'text',
      text:
        '- **And what is Ã¢â‚¬Å“User ExperienceÃ¢â‚¬Â, and whatÃ¢â‚¬â„¢s its purpose?**\n\n  ItÃ¢â‚¬â„¢s the overall experience of a player while they interact with a game or application. It includes how intuitive, enjoyable, and accessible the experience feels from the moment they launch the game to when they stop playing.',
    },
    {
      type: 'text',
      text:
    ...
    },
    {
      type: 'text',
      text:
        '- **LetÃ¢â‚¬â„¢s quickly talk about letters:**\n\n  Did you know that Ã¢â‚¬Âmaking lettersÃ¢â‚¬Â is a job? Ã¢â‚¬Å“Typography DesignersÃ¢â‚¬Â -which is their official name- create letters to fit physical supports like print, desktop and mobile. They also make sure they can be read up close or far away, as well as by people with cognitive disabilities. For example: it has been proven that people with dyslexia can benefit from specific traits in letter design, which is how the font Ã¢â‚¬Å“DyslexieÃ¢â‚¬Â was designed.',
    },
    {
      type: 'image',
      url:
        'https://public-resources.AirStudio.io/staging/course/images/2e9daaf5-c2a8-4401-8446-6b7bd6f38771.png',
    },
    {
      type: 'text',
      text:
    ...
    { type: 'text', text: '- **LetÃ¢â‚¬â„¢s talk about color**' },
    {
      type: 'text',
      text:
        '&#9;Color is a fascinating phenomenon that occurs when surfaces reflect light, which our eyes then perceive. What makes color especially interesting is that it exists in our eyesÃ¢â‚¬â€meaning different people can perceive the same color in different ways:',
    },
    {
      type: 'text',
      text:
        '&#9;In 2015 *this* dress became viral because certain people saw a red/golden dress, while others saw a blue/black dressÃ¢â‚¬Â¦ ',
    },
    {
      type: 'image',
      url:
        'https://public-resources.AirStudio.io/staging/course/images/d079a8a9-4ebf-4933-b02a-6fc9b95e0d46.png',
    },
    {
      type: 'text',
      text:
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: 'image',
          url:
            'https://public-resources.AirStudio.io/staging/course/images/f97e3d55-326b-49a2-9fa3-49673822115c.jpg',
        },
      ],
      answer: {
        items: [
...
export const textBasedCourseChapterWithCallout: TextBasedCourseChapter = {
  ...
  items: [
    ...
    },
    {
      ...
      kind: 'info',
      text:
        '3 Ceci est un encaddrÃƒÂ© **informatif**. Il utilise les couleurs `blue` par dÃƒÂ©faut. Il est parfait pour fournir des dÃƒÂ©tails supplÃƒÂ©mentaires ou des prÃƒÂ©cisions techniques. Les blocs de `code` sont ÃƒÂ©galement bien formatÃƒÂ©s.',
    },
  ],
...
export const premiumCourse: Course = {
  ...
  imageUrlByLocale: {
    en:
      'https://public-resources.AirStudio.io/course/AirStudio-premium-course.jpeg',
  },
  titleByLocale: {
    en: 'Complete AirStudio Master course',
    'fr-FR': 'Cours complet de maÃƒÂ®trise de AirStudio',
    'ar-SA': 'Ã˜Â¯Ã™Ë†Ã˜Â±Ã˜Â© Ã˜Â§Ã˜Â­Ã˜ÂªÃ˜Â±Ã˜Â§Ã™Â AirStudio Ã˜Â§Ã™â€žÃ™Æ’Ã˜Â§Ã™â€¦Ã™â€žÃ˜Â©',
    'de-DE': 'Kompletter AirStudio-Meisterkurs',
    'es-ES': 'Curso completo de maestro de AirStudio',
    'fi-FI': 'TÃƒÂ¤ydellinen AirStudio Master -kurssi',
    'it-IT': 'Corso completo di AirStudio Master',
    'ja-JP': 'AirStudioÃ£Æ’Å¾Ã£â€šÂ¹Ã£â€šÂ¿Ã£Æ’Â¼Ã¥Â®Å’Ã¥â€¦Â¨Ã£â€šÂ³Ã£Æ’Â¼Ã£â€šÂ¹',
    'ko-KR': 'AirStudio Ã«Â§Ë†Ã¬Å Â¤Ã­â€žÂ° Ã¬â„¢â€žÃ«Â²Â½ Ã¬Â½â€Ã¬Å Â¤',
    'pl-PL': 'Kompletny kurs mistrzowski AirStudio',
    'pt-BR': 'Curso completo de mestre em AirStudio',
    'ru-RU': 'ÃÅ¸ÃÂ¾ÃÂ»ÃÂ½Ã‘â€¹ÃÂ¹ ÃÂ¼ÃÂ°Ã‘ÂÃ‘â€šÃÂµÃ‘â‚¬-ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘Â ÃÂ¿ÃÂ¾ AirStudio',
    'sl-SI': 'Celovit AirStudio mojstrski teÃ„Âaj',
    'tr-TR': 'Tam AirStudio Usta Kursu',
    'uk-UA': 'ÃÅ¸ÃÂ¾ÃÂ²ÃÂ½ÃÂ¸ÃÂ¹ ÃÂ¼ÃÂ°ÃÂ¹Ã‘ÂÃ‘â€šÃÂµÃ‘â‚¬-ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘Â ÃÂ· AirStudio',
    'zh-CN': 'AirStudioÃ¥Â®Å’Ã¦â€¢Â´Ã¥Â¤Â§Ã¥Â¸Ë†Ã¨Â¯Â¾Ã§Â¨â€¹',
  },
  shortDescriptionByLocale: {
    en:
      'Master the skills to create, polish and release your own game to the world. This chapter-by-chapter course is designed to let you learn everything you need to know about AirStudio and gamedev.',
    'fr-FR':
      'MaÃƒÂ®trisez les compÃƒÂ©tences pour crÃƒÂ©er, peaufiner et publier votre propre jeu. Ce cours chapitre par chapitre est conÃƒÂ§u pour vous apprendre tout ce quÃ¢â‚¬â„¢il faut savoir sur AirStudio et le dÃƒÂ©veloppement de jeux.',
    'ar-SA':
      'Ã˜Â£Ã˜ÂªÃ™â€šÃ™â€  Ã™â€¦Ã™â€¡Ã˜Â§Ã˜Â±Ã˜Â§Ã˜Âª Ã˜Â¥Ã™â€ Ã˜Â´Ã˜Â§Ã˜Â¡ Ã™Ë†Ã˜ÂªÃ˜Â·Ã™Ë†Ã™Å Ã˜Â± Ã™Ë†Ã™â€ Ã˜Â´Ã˜Â± Ã™â€žÃ˜Â¹Ã˜Â¨Ã˜ÂªÃ™Æ’ Ã˜Â§Ã™â€žÃ˜Â®Ã˜Â§Ã˜ÂµÃ˜Â©. Ã™â€¡Ã˜Â°Ã˜Â§ Ã˜Â§Ã™â€žÃ™Æ’Ã™Ë†Ã˜Â±Ã˜Â³ Ã˜Â§Ã™â€žÃ™â€¦Ã™ÂÃ™â€šÃ˜Â³Ã™â€¦ Ã˜Â¥Ã™â€žÃ™â€° Ã™ÂÃ˜ÂµÃ™Ë†Ã™â€ž Ã™â€¦Ã˜ÂµÃ™â€¦Ã™â€¦ Ã™â€žÃ™Å Ã˜Â¹Ã™â€žÃ™â€¦Ã™Æ’ Ã™Æ’Ã™â€ž Ã™â€¦Ã˜Â§ Ã˜ÂªÃ˜Â­Ã˜ÂªÃ˜Â§Ã˜Â¬ Ã™â€¦Ã˜Â¹Ã˜Â±Ã™ÂÃ˜ÂªÃ™â€¡ Ã˜Â¹Ã™â€  AirStudio Ã™Ë†Ã˜ÂªÃ˜Â·Ã™Ë†Ã™Å Ã˜Â± Ã˜Â§Ã™â€žÃ˜Â£Ã™â€žÃ˜Â¹Ã˜Â§Ã˜Â¨.',
    'de-DE':
      'Meistern Sie die FÃƒÂ¤higkeiten, um Ihr eigenes Spiel zu erstellen, zu verfeinern und zu verÃƒÂ¶ffentlichen. Dieser Kurs, der Schritt fÃƒÂ¼r Schritt aufgebaut ist, vermittelt Ihnen alles, was Sie ÃƒÂ¼ber AirStudio und Spieleentwicklung wissen mÃƒÂ¼ssen.',
    'es-ES':
      'Domina las habilidades para crear, perfeccionar y lanzar tu propio juego al mundo. Este curso por capÃƒÂ­tulos estÃƒÂ¡ diseÃƒÂ±ado para enseÃƒÂ±arte todo lo que necesitas saber sobre AirStudio y el desarrollo de juegos.',
    'fi-FI':
      'Hallitse taidot luoda, hiota ja julkaista oma pelisi maailmalle. TÃƒÂ¤mÃƒÂ¤ luku kerrallaan etenevÃƒÂ¤ kurssi on suunniteltu opettamaan sinulle kaikki tarvittava AirStudioistÃƒÂ¤ ja pelinkehityksestÃƒÂ¤.',
    'it-IT':
      'Padroneggia le competenze per creare, rifinire e pubblicare il tuo gioco. Questo corso capitolo per capitolo ÃƒÂ¨ progettato per insegnarti tutto ciÃƒÂ² che devi sapere su AirStudio e lo sviluppo di giochi.',
    'ja-JP':
      'Ã£â€šÂ²Ã£Æ’Â¼Ã£Æ’Â Ã£â€šâ€™Ã¤Â½Å“Ã¦Ë†ÂÃ£Ââ€”Ã£â‚¬ÂÃ§Â£Â¨Ã£ÂÂÃ¤Â¸Å Ã£Ââ€™Ã£â‚¬ÂÃ¤Â¸â€“Ã§â€¢Å’Ã£ÂÂ«Ã£Æ’ÂªÃ£Æ’ÂªÃ£Æ’Â¼Ã£â€šÂ¹Ã£Ââ„¢Ã£â€šâ€¹Ã£â€šÂ¹Ã£â€šÂ­Ã£Æ’Â«Ã£â€šâ€™Ã§Â¿â€™Ã¥Â¾â€”Ã£Ââ€”Ã£ÂÂ¾Ã£Ââ€”Ã£â€šâ€¡Ã£Ââ€ Ã£â‚¬â€šÃ£Ââ€œÃ£ÂÂ®Ã§Â«Â Ã£Ââ€Ã£ÂÂ¨Ã£ÂÂ®Ã£â€šÂ³Ã£Æ’Â¼Ã£â€šÂ¹Ã£ÂÂ¯Ã£â‚¬ÂAirStudioÃ£ÂÂ¨Ã£â€šÂ²Ã£Æ’Â¼Ã£Æ’Â Ã©â€“â€¹Ã§â„¢ÂºÃ£ÂÂ«Ã£ÂÂ¤Ã£Ââ€žÃ£ÂÂ¦Ã¥Â­Â¦Ã£ÂÂ¹Ã£â€šâ€¹Ã£â€šË†Ã£Ââ€ Ã¨Â¨Â­Ã¨Â¨Ë†Ã£Ââ€¢Ã£â€šÅ’Ã£ÂÂ¦Ã£Ââ€žÃ£ÂÂ¾Ã£Ââ„¢Ã£â‚¬â€š',
    'ko-KR':
      'ÃªÂ²Å’Ã¬Å¾â€žÃ¬Ââ€ž Ã«Â§Å’Ã«â€œÂ¤ÃªÂ³Â  Ã«â€¹Â¤Ã«â€œÂ¬Ã¬â€“Â´ Ã¬â€žÂ¸ÃªÂ³â€žÃ¬â€”Â Ã¬Â¶Å“Ã¬â€¹Å“Ã­â€¢ËœÃ«Å â€ ÃªÂ¸Â°Ã¬Ë†Â Ã¬Ââ€ž Ã«Â§Ë†Ã¬Å Â¤Ã­â€žÂ°Ã­â€¢ËœÃ¬â€žÂ¸Ã¬Å¡â€. Ã¬ÂÂ´ Ã¬Â±â€¢Ã­â€žÂ°Ã«Â³â€ž Ã¬Â½â€Ã¬Å Â¤Ã«Å â€ AirStudioÃªÂ³Â¼ ÃªÂ²Å’Ã¬Å¾â€ž ÃªÂ°Å“Ã«Â°Å“Ã¬â€”Â Ã­â€¢â€žÃ¬Å¡â€Ã­â€¢Å“ Ã«ÂªÂ¨Ã«â€œÂ  ÃªÂ²Æ’Ã¬Ââ€ž Ã­â€¢â„¢Ã¬Å ÂµÃ­â€¢ËœÃ«Ââ€žÃ«Â¡Â Ã¬â€žÂ¤ÃªÂ³â€žÃ«ÂËœÃ¬â€”Ë†Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤.',
    'pl-PL':
      'Opanuj umiejÃ„â„¢tnoÃ…â€ºci tworzenia, dopracowywania i wydawania wÃ…â€šasnej gry. Ten kurs krok po kroku pozwoli Ci nauczyÃ„â€¡ siÃ„â„¢ wszystkiego o AirStudio i tworzeniu gier.',
    'pt-BR':
      'Domine as habilidades para criar, aprimorar e lanÃƒÂ§ar seu prÃƒÂ³prio jogo para o mundo. Este curso capÃƒÂ­tulo por capÃƒÂ­tulo foi projetado para ensinar tudo o que vocÃƒÂª precisa saber sobre AirStudio e desenvolvimento de jogos.',
    'ru-RU':
      'ÃÅ¾Ã‘ÂÃÂ²ÃÂ¾ÃÂ¹Ã‘â€šÃÂµ ÃÂ½ÃÂ°ÃÂ²Ã‘â€¹ÃÂºÃÂ¸ Ã‘ÂÃÂ¾ÃÂ·ÃÂ´ÃÂ°ÃÂ½ÃÂ¸Ã‘Â, ÃÂ´ÃÂ¾Ã‘â‚¬ÃÂ°ÃÂ±ÃÂ¾Ã‘â€šÃÂºÃÂ¸ ÃÂ¸ ÃÂ²Ã‘â€¹ÃÂ¿Ã‘Æ’Ã‘ÂÃÂºÃÂ° Ã‘ÂÃÂ¾ÃÂ±Ã‘ÂÃ‘â€šÃÂ²ÃÂµÃÂ½ÃÂ½ÃÂ¾ÃÂ¹ ÃÂ¸ÃÂ³Ã‘â‚¬Ã‘â€¹. ÃÂ­Ã‘â€šÃÂ¾Ã‘â€š ÃÂ¿ÃÂ¾Ã‘ÂÃ‘â€šÃÂ°ÃÂ¿ÃÂ½Ã‘â€¹ÃÂ¹ ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘Â ÃÂ¿ÃÂ¾ÃÂ¼ÃÂ¾ÃÂ¶ÃÂµÃ‘â€š ÃÂ²ÃÂ°ÃÂ¼ ÃÂ¸ÃÂ·Ã‘Æ’Ã‘â€¡ÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ²Ã‘ÂÃ‘â€˜, Ã‘â€¡Ã‘â€šÃÂ¾ ÃÂ½Ã‘Æ’ÃÂ¶ÃÂ½ÃÂ¾ ÃÂ·ÃÂ½ÃÂ°Ã‘â€šÃ‘Å’ ÃÂ¾ AirStudio ÃÂ¸ Ã‘â‚¬ÃÂ°ÃÂ·Ã‘â‚¬ÃÂ°ÃÂ±ÃÂ¾Ã‘â€šÃÂºÃÂµ ÃÂ¸ÃÂ³Ã‘â‚¬.',
    'sl-SI':
      'Obvladajte veÃ…Â¡Ã„Âine za ustvarjanje, izboljÃ…Â¡anje in objavo svoje igre. Ta teÃ„Âaj po poglavjih je zasnovan za uÃ„Âenje vsega, kar morate vedeti o AirStudio in razvoju iger.',
    'tr-TR':
      'Kendi oyununuzu oluÃ…Å¸turmak, cilalamak ve dÃƒÂ¼nyaya sunmak iÃƒÂ§in gerekli becerileri ÃƒÂ¶Ã„Å¸renin. Bu bÃƒÂ¶lÃƒÂ¼m bÃƒÂ¶lÃƒÂ¼m kursu, AirStudio ve oyun geliÃ…Å¸tirme hakkÃ„Â±nda bilmeniz gereken her Ã…Å¸eyi ÃƒÂ¶Ã„Å¸renmenizi saÃ„Å¸lamak ÃƒÂ¼zere tasarlanmÃ„Â±Ã…Å¸tÃ„Â±r.',
    'uk-UA':
      'ÃÅ¾ÃÂ¿ÃÂ°ÃÂ½Ã‘Æ’ÃÂ¹Ã‘â€šÃÂµ ÃÂ½ÃÂ°ÃÂ²ÃÂ¸Ã‘â€¡ÃÂºÃÂ¸ Ã‘ÂÃ‘â€šÃÂ²ÃÂ¾Ã‘â‚¬ÃÂµÃÂ½ÃÂ½Ã‘Â, Ã‘Æ’ÃÂ´ÃÂ¾Ã‘ÂÃÂºÃÂ¾ÃÂ½ÃÂ°ÃÂ»ÃÂµÃÂ½ÃÂ½Ã‘Â Ã‘â€šÃÂ° ÃÂ²ÃÂ¸ÃÂ¿Ã‘Æ’Ã‘ÂÃÂºÃ‘Æ’ ÃÂ²ÃÂ»ÃÂ°Ã‘ÂÃÂ½ÃÂ¾Ã‘â€” ÃÂ³Ã‘â‚¬ÃÂ¸. ÃÂ¦ÃÂµÃÂ¹ ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘Â ÃÂ¿ÃÂ¾ Ã‘â‚¬ÃÂ¾ÃÂ·ÃÂ´Ã‘â€“ÃÂ»ÃÂ°Ã‘â€¦ ÃÂ´ÃÂ¾ÃÂ¿ÃÂ¾ÃÂ¼ÃÂ¾ÃÂ¶ÃÂµ ÃÂ²ÃÂ°ÃÂ¼ ÃÂ²ÃÂ¸ÃÂ²Ã‘â€¡ÃÂ¸Ã‘â€šÃÂ¸ ÃÂ²Ã‘ÂÃÂµ ÃÂ¿Ã‘â‚¬ÃÂ¾ AirStudio Ã‘â€“ Ã‘â‚¬ÃÂ¾ÃÂ·Ã‘â‚¬ÃÂ¾ÃÂ±ÃÂºÃ‘Æ’ Ã‘â€“ÃÂ³ÃÂ¾Ã‘â‚¬.',
    'zh-CN':
      'Ã¦Å½Å’Ã¦ÂÂ¡Ã¥Ë†Â¶Ã¤Â½Å“Ã£â‚¬ÂÃ¦â€°â€œÃ§Â£Â¨Ã¥Â¹Â¶Ã¥Ââ€˜Ã¥Â¸Æ’Ã¦â€šÂ¨Ã¨â€¡ÂªÃ¥Â·Â±Ã§Å¡â€žÃ¦Â¸Â¸Ã¦Ë†ÂÃ§Å¡â€žÃ¦Å â‚¬Ã¨Æ’Â½Ã£â‚¬â€šÃ¦Å“Â¬Ã§Â«Â Ã¨Å â€šÃ¥Â¼ÂÃ¨Â¯Â¾Ã§Â¨â€¹Ã¦â€”Â¨Ã¥Å“Â¨Ã¦â€¢â„¢Ã¤Â¼Å¡Ã¦â€šÂ¨Ã¥â€¦Â³Ã¤ÂºÅ½AirStudioÃ¥â€™Å’Ã¦Â¸Â¸Ã¦Ë†ÂÃ¥Â¼â‚¬Ã¥Ââ€˜Ã§Å¡â€žÃ¦â€°â‚¬Ã¦Å“â€°Ã§Å¸Â¥Ã¨Â¯â€ Ã£â‚¬â€š',
  },
  levelByLocale: {
    en: 'Beginner level',
    'fr-FR': 'Niveau dÃƒÂ©butant',
    'ar-SA': 'Ã™â€¦Ã˜Â³Ã˜ÂªÃ™Ë†Ã™â€° Ã˜Â§Ã™â€žÃ™â€¦Ã˜Â¨Ã˜ÂªÃ˜Â¯Ã˜Â¦Ã™Å Ã™â€ ',
    'de-DE': 'AnfÃƒÂ¤ngerstufe',
    'es-ES': 'Nivel principiante',
    'fi-FI': 'Aloittelijan taso',
    'it-IT': 'Livello principiante',
    'ja-JP': 'Ã¥Ë†ÂÃ¥Â¿Æ’Ã¨â‚¬â€¦Ã¥Ââ€˜Ã£Ââ€˜Ã£Æ’Â¬Ã£Æ’â„¢Ã£Æ’Â«',
    'ko-KR': 'Ã¬Â´Ë†ÃªÂ¸â€° Ã¬Ë†ËœÃ¬Â¤â‚¬',
    'pl-PL': 'Poziom poczÃ„â€¦tkujÃ„â€¦cy',
    'pt-BR': 'NÃƒÂ­vel iniciante',
    'ru-RU': 'ÃÂÃÂ°Ã‘â€¡ÃÂ°ÃÂ»Ã‘Å’ÃÂ½Ã‘â€¹ÃÂ¹ Ã‘Æ’Ã‘â‚¬ÃÂ¾ÃÂ²ÃÂµÃÂ½Ã‘Å’',
    'sl-SI': 'ZaÃ„ÂetniÃ…Â¡ka raven',
    'tr-TR': 'BaÃ…Å¸langÃ„Â±ÃƒÂ§ seviyesi',
    'uk-UA': 'ÃÅ¸ÃÂ¾Ã‘â€¡ÃÂ°Ã‘â€šÃÂºÃÂ¾ÃÂ²ÃÂ¸ÃÂ¹ Ã‘â‚¬Ã‘â€“ÃÂ²ÃÂµÃÂ½Ã‘Å’',
    'zh-CN': 'Ã¥Ë†ÂÃ§ÂºÂ§Ã¦Â°Â´Ã¥Â¹Â³',
  },
  includedInSubscriptions: ['AirStudio_silver', 'AirStudio_gold'],
