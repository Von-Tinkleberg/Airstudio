...
jest.mock('../../Utils/AirStudioServices/Project');
...
const makeTestProjectWithResourcesToDownload = () => {
  ...
  // Resource with a private URL
  {
    ...
    newResource.setFile(
      'https://private-assets.AirStudio.io/file-to-download.png?token=123'
    );
...
describe('CloudResourceFetcher', () => {
  ...
  it('fetches resources and can download them', async () => {
    ...
    mockFn(downloadUrlsToBlobs).mockImplementationOnce(() => [
      ...
      },
      {
        item: {
          ...
          filename:
            "My Blob Resource To Download with æ±‰å­— and funkÂ¥__character__'_.png",
        },
        blob: 'some blob',
        error: null,
      },
    ...
    mockFn(uploadProjectResourceFiles).mockImplementation(() => [
      {
        url:
          'https://project-resources.AirStudio.io/fake-cloud-project-id/file-to-download.png',
        error: null,
      },
      {
        url:
          "https://project-resources.AirStudio.io/fake-cloud-project-id/My Blob Resource To Download with æ±‰å­— and funkÂ¥__character__'_.png",
        error: null,
      },
    ]);
