...
const productAuthorizedUrl =
  'https://private-assets.AirStudio.io/a2adcae7-ceba-4c0d-ad0f-411bf83692ea/resources/Misc/stars_levels (3) æ±‰å­—.png?token=eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnZGV2ZWxvcC1zaG9wLWFwaSIsImF1ZCI6IjNwejJvWEZHSmVTaTVyVjROQ0pkclU4MjVUVDIiLCJleHAiOjE2NjY5NjM5NDY1OTUsInN1YiI6WyJhMmFkY2FlNy1jZWJhLTRjMGQtYWQwZi00MTFiZjgzNjkyZWEiLCJjM2ZmZjUyZS1lMTZjLTQxMTYtYTYzNS03ZjUzOGRmN2Y1YWEiXX0%3D.WY0V%2B2ypgT0PEWPUKVPSaiazKNfl4ib%2Bf89CpgcdxGo';
const encodedProductAuthorizedUrl =
  'https://private-assets.AirStudio.io/a2adcae7-ceba-4c0d-ad0f-411bf83692ea/resources/Misc/stars_levels%20(3)%20%E6%B1%89%E5%AD%97.png?token=eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnZGV2ZWxvcC1zaG9wLWFwaSIsImF1ZCI6IjNwejJvWEZHSmVTaTVyVjROQ0pkclU4MjVUVDIiLCJleHAiOjE2NjY5NjM5NDY1OTUsInN1YiI6WyJhMmFkY2FlNy1jZWJhLTRjMGQtYWQwZi00MTFiZjgzNjkyZWEiLCJjM2ZmZjUyZS1lMTZjLTQxMTYtYTYzNS03ZjUzOGRmN2Y1YWEiXX0%3D.WY0V%2B2ypgT0PEWPUKVPSaiazKNfl4ib%2Bf89CpgcdxGo';
const publicResourceUrl =
  'https://asset-resources.AirStudio.io/public-resources/16x16 Dungeon Tileset/Armor/0a130324cd2501a97027b518b41231896a81e25034fd3a7baaca9581d079f8b6_Imp Run 2.png';
const encodedPublicResourceUrl =
  'https://asset-resources.AirStudio.io/public-resources/16x16%20Dungeon%20Tileset/Armor/0a130324cd2501a97027b518b41231896a81e25034fd3a7baaca9581d079f8b6_Imp%20Run%202.png';
...
const makeTestProjectWithBlobResourcesToDownload = () => {
  ...
  // by the LocalResourceMover. Use a name that needs to be adapted to be a valid filename.
  {
    const newResource = new gd.ImageResource();
    newResource.setName(
      'My Blob Resource To Download with æ±‰å­— and funkÂ¥/\\character$*\'"'
    );
...
describe('LocalResourceMover', () => {
  ...
  it('fetches resources and can download them', async () => {
    ...
    expect(
      ...
      path.join('assets', 'stars_levels (3) æ±‰å­—.png')
    );
    expect(
      optionalRequire.mockElectron.ipcRenderer.invoke
    ).toHaveBeenCalledWith(
  ...
  describe('Support for blobs', () => {
    it('fetches resources with blobs and can download them', async () => {
      ...
      expect(
        ...
        path.join(
          'assets',
          "My Blob Resource To Download with æ±‰å­— and funkÂ¥/character__'_"
        )
      );
      expect(
        optionalRequire.mockElectron.ipcRenderer.invoke
