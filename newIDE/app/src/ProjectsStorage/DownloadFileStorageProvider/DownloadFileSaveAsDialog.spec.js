...
const makeTestProjectWithResourcesToDownload = () => {
  ...
  // Add a resource from the AirStudio cloud bucket.
  {
    const newResource = new gd.ImageResource();
  ...
  // Add another resource with the same "filename" but a different hash.
  {
    ...
    newResource.setFile(
      'https://project-resources.AirStudio.io/a9fe5bce-de39-4147-a669-93fc5cd69632/resources/12345bc678921eb4bfa2d04e5dc6a16b75f7b239f3163d0c5efe64d4cc501711-Pea-Happy.png'
    );
    project.getResourcesManager().addResource(newResource);
    newResource.delete();
  }
  // Add another resource that will error during the download
  {
    ...
    newResource.setFile(
      'https://project-resources.AirStudio.io/a9fe5bce-de39-4147-a669-93fc5cd69632/resources/12345bc678921eb4bfa2d04e5dc6a16b75f7b239f3163d0c5efe64d4cc501711-Test.png'
    );
    project.getResourcesManager().addResource(newResource);
    newResource.delete();
  }
...
describe('DownloadFileSaveAsDialog', () => {
  describe('downloadResourcesAsBlobs', () => {
    ...
    it('downloads files as blobs', async () => {
      ...
      // AirStudio cloud resources have been downloaded as blobs:
