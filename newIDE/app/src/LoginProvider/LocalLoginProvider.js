...
import type { IdentityProvider } from '../Utils/AirStudioServices/Authentication';
import {
  setupAuthenticationWebSocket,
  terminateWebSocket,
} from '../Utils/AirStudioServices/Authorization';
import Window from '../Utils/Window';
import { UserCancellationError } from './Utils';

const isDev = Window.isDev();

const authenticationPortalUrl = 'https://auth.AirStudio.io';
