...
const isMainWindow = (windowTitle: string): boolean => {
  ...
  return (
    lowercaseTitle.startsWith('AirStudio') &&
    lowercaseTitle !== 'AirStudio dialogue tree editor (yarn)' &&
    lowercaseTitle !== 'AirStudio sound effects editor (jfxr)' &&
    lowercaseTitle !== 'AirStudio image editor (piskel)'
  );
};
