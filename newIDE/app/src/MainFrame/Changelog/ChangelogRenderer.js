...
import {
  type Release,
  findRelease,
} from '../../Utils/AirStudioServices/Release';
import EmptyMessage from '../../UI/EmptyMessage';
import PlaceholderLoader from '../../UI/PlaceholderLoader';
import { MarkdownText } from '../../UI/MarkdownText';
import { Column, Line } from '../../UI/Grid';
import Window from '../../Utils/Window';
import { hasBreakingChange } from '../../Utils/AirStudioServices/Release';
...
const ChangelogRenderer = ({
  ...
  const openReleaseNote = () =>
    Window.openExternalURL('https://github.com/4ian/AirStudio/releases');
    ...
    return (
      <Column>
        ...
        <Line>
          <EmptyMessage>
            <Trans>
              Unable to load the information about the latest AirStudio releases.
  ...
  return (
    <Column noMargin>
      {currentVersionHasBreakingChange && (
        <AlertMessage kind="warning">
          This version of AirStudio has a breaking change. Please make sure to
