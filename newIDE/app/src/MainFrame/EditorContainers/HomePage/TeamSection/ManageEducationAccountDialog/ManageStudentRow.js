...
const ManageStudentRow = ({
  ...
  const isInvitedStudent = !member.isEmailAutogenerated;
  ...
  if (isMobile) {
    return (
      <>
        <Grid item xs={4} style={styles.mobileCell}>
          {usernameCell}
        </Grid>
        <Grid item xs={4} style={styles.mobileCell}>
          {emailCell}
  ...
  return (
    <>
      <Grid item xs={9} style={styles.cell}>
        <LineStackLayout noMargin alignItems="center">
          {usernameCell}
          {emailCell}
        </LineStackLayout>
      </Grid>
      <Grid item xs={3} style={styles.cell}>
        {passwordCell}
      </Grid>
      {editDialog}
    </>
