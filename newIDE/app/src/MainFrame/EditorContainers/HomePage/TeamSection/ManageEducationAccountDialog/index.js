...
import { type EditUserChanges } from '../../../../../Utils/AirStudioServices/User';
  ...
  const onOpenPurchaseSeatsDialog = React.useCallback(
    () => {
      showAlert({
        ...
        message: t`To update your seats, contact us at education@AirStudio.io with the details of your current account and how many seats you would like.`,
      });
    },
    [showAlert]
  );
