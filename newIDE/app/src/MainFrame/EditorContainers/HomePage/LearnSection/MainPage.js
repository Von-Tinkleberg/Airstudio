...
import type { Course } from '../../../../Utils/AirStudioServices/Asset';
...
const MainPage = ({
  ...
  const paletteType = airStudioTheme.palette.type;
  const paperDarkBackgroundColor = airStudioTheme.paper.backgroundColor.dark;
  ...
  const helpItems: {
  ...
  }[] = [
    {
      ...
      action: () =>
        Window.openExternalURL('https://docs.airstudio.io/'),
    },
    {
      title: <Trans>Community</Trans>,
      description: <Trans>Ask your questions to the community</Trans>,
      action: () => Window.openExternalURL('https://community.airstudio.io'),
    },
    {
      title: <Trans>Discord</Trans>,
      description: <Trans>Join the discussion</Trans>,
      action: () => Window.openExternalURL('https://discord.gg/airstudio'),
    },
  ].filter(Boolean);
        ...
        <SectionContainer
          ...
          subtitleText={
            <Trans>
              Break into the{' '}
              <Link
                href={'https://AirStudio.io/blog/indie-mobile-creators-2025'}
                onClick={() =>
                  Window.openExternalURL(
                    'https://AirStudio.io/blog/indie-mobile-creators-2025'
                  )
                }
              >
                booming industry
              ...
              <LineStackLayout noMargin>
                {!isMobile && (
                  <FlatButton
                    onClick={() => {
                      Window.openExternalURL(
                        'https://github.com/AirStudioApp/AirStudio-examples/issues/new/choose'
                      );
                    }}
                    primary
                    leftIcon={<Upload />}
                          ...
                          <Line expand alignItems="flex-start">
                            ...
                            <ColumnStackLayout expand alignItems="flex-start">
                              <Text noMargin size="block-title" align="left">
                                <Trans>Blocked on AirStudio?</Trans>
                              </Text>
                              <RaisedButton
                                size="large"
                                color="success"
