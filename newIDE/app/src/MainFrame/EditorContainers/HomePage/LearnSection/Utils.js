...
import {
  ...
  type Tutorial,
} from '../../../../Utils/AirStudioServices/Tutorial';
import { type WindowSizeType } from '../../../../UI/Responsive/ResponsiveWindowMeasurer';
import { type Limits } from '../../../../Utils/AirStudioServices/Usage';
...
export const TUTORIAL_CATEGORY_TEXTS = {
  ...
  'official-beginner': {
    ...
    description: ((
      <Trans>Learn the fundamental principles of AirStudio</Trans>
    ): React.Node),
  },
  'official-intermediate': {
    title: (<Trans>Intermediate course</Trans>: React.Node),
    description: ((
      <Trans>Learn all the game-building mechanics of AirStudio</Trans>
    ): React.Node),
  },
  'official-advanced': {
  ...
  'education-curriculum': {
    ...
    description: ((
      <Trans>
        For teachers and educators having the AirStudio Education subscription.
