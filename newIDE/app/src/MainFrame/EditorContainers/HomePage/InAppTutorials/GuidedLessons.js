...
import {
  ...
  guidedLessonsIds,
} from '../../../../Utils/AirStudioServices/InAppTutorial';
...
export const allInAppTutorialsCards = [
  {
    ...
    title: (t`Platformer`: any),
    description: (t`Make a knight jump and run in this platformer game.`: any),
    shortDescription: (t`Make a knight jump and run.`: any),
    durationInMinutes: 1,
    renderImage: (props: any): React.Node => <Platformer {...props} />,
  },
  {
    id: CAMERA_PARALLAX_IN_APP_TUTORIAL_ID,
    title: (t`Background and cameras`: any),
    shortDescription: (t`Follow a character with scrolling background.`: any),
    description: (t`Follow this Castlevania-type character with the camera, while the background scrolls.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <Parallax {...props} />,
  },
  {
    id: TOP_DOWN_RPG_MOVEMENT_ID,
    title: (t`Top-Down RPG Pixel Perfect`: any),
    shortDescription: (t`Move like in retro Pokemon games.`: any),
    description: (t`Make a character move like in a retro Pokemon game.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <TopDownRPGMovement {...props} />,
  },
  {
    id: JOYSTICK_IN_APP_TUTORIAL_ID,
    title: (t`Joystick controls`: any),
    shortDescription: (t`Control a spaceship with a joystick.`: any),
    description: (t`Control your spaceship with a joystick, while avoiding asteroids.`: any),
    durationInMinutes: 1,
    renderImage: (props: any): React.Node => <Joystick {...props} />,
  },
  {
    id: OBJECT_3D_IN_APP_TUTORIAL_ID,
    title: (t`3D platforms`: any),
    shortDescription: (t`Place 3D platforms in a 2D game.`: any),
    description: (t`Place 3D platforms in this 2D platformer, creating a path to the end.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <Object3D {...props} />,
  },
  {
    id: HEALTH_BAR_IN_APP_TUTORIAL_ID,
    title: (t`Health bar`: any),
    shortDescription: (t`Add a health bar for handle damage.`: any),
    description: (t`Add a health bar to this jumping character, losing health when hitting spikes.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <HealthBar {...props} />,
  },
  {
    id: TILEMAP_PLATFORMER_ID,
    title: (t`Paint a Level with Tiles`: any),
    shortDescription: (t`Build dynamic levels with tiles.`: any),
    description: (t`Use a Tilemap to build a level and change it dynamically during the game.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <TilemapPlatformer {...props} />,
  },
  {
    id: FIRE_A_BULLET_ID,
    title: (t`Fire a Bullet`: any),
    shortDescription: (t`Fire bullets in an Asteroids game.`: any),
    description: (t`Fire bullets in this Asteroids game. Get ready for a Star Wars show.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <FireABullet {...props} />,
  },
  {
    id: TIMER_IN_APP_TUTORIAL_ID,
    title: (t`Time score`: any),
    shortDescription: (t`Add a time attack mode.`: any),
    description: (t`Add a time attack mode, where you have to reach the end as fast as possible.`: any),
    durationInMinutes: 2,
    renderImage: (props: any): React.Node => <Timer {...props} />,
  },
  {
    id: COOP_PLATFORMER_ID,
    title: (t`Co-op Multiplayer`: any),
    shortDescription: (t`Transform a game into a multiplayer experience.`: any),
    description: (t`Transform this platformer into a co-op game, where two players can play together.`: any),
    durationInMinutes: 3,
    renderImage: (props: any): React.Node => <CoopPlatformer {...props} />,
  },
  {
    id: PLINKO_MULTIPLIER_IN_APP_TUTORIAL_ID,
    title: (t`Score multiplier`: any),
    shortDescription: (t`Multiply scores with collectibles.`: any),
    description: (t`Transform this Plinko game with collectibles that multiply your score.`: any),
    durationInMinutes: 3,
