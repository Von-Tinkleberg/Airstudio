...
import { FLING_GAME_IN_APP_TUTORIAL_ID } from '../../../../Utils/AirStudioServices/InAppTutorial';
            ...
            {isFlingTutorialComplete ? (
              <GridListTile>
                <InAppTutorialPhaseCard
                  ...
                  description={t`Find your finished game on the â€œBuildâ€ section. Or restart the tutorial by clicking on the card.`}
                  shortDescription={t`Your game is in the â€œBuildâ€ section or you can restart the tutorial.`}
                  size="banner"
                  locked={false}
                  disabled={false}
                  renderImage={props => (
