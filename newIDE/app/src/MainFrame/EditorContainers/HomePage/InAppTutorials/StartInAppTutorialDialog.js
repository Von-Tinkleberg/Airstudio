...
import { type InAppTutorialShortHeader } from '../../../../Utils/AirStudioServices/InAppTutorial';
    ...
    return {
      ...
      content: (
        <>
          ...
          <Text>
            <Trans>
              AirStudio will save your progress, so you can take a break if you
              need.
            </Trans>
          </Text>
        </>
    ...
    content: (
      <>
        ...
        {!tutorialShortHeader.isMiniTutorial && (
          <Text>
            <Trans>
              This is a multichapter tutorial. AirStudio will save your progress
