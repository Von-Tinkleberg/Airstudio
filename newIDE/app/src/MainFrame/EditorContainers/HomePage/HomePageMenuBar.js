...
const HomePageMenuBar = ({
  ...
  const largeScreenOnlyButtons: {
    ...
    {
      label: <Trans>About AirStudio</Trans>,
      id: 'about-AirStudio',
      onClick: onOpenAbout,
      getIcon: ({ color, fontSize }) => (
        <AirStudioGLogo fontSize={fontSize} color={color} />
      ),
    },
  ];
    ...
    return (
      <Paper
        ...
        style={{
          ...
          borderTop: `1px solid ${airStudioTheme.home.separator.color}`,
        }}
      >
  ...
  return (
    <Paper
      style={{
        ...
        borderRight: `1px solid ${airStudioTheme.home.separator.color}`,
      }}
      square
      background="dark"
    >
