    ...
    () => {
      openSubscriptionDialog({
        analyticsMetadata: {
          ...
          recommendedPlanId: 'AirStudio_education',
  ...
  const renderCard = (key: string) => (
    ...
    >
      <ColumnStackLayout alignItems="flex-start" expand noMargin>
        ...
        <Text>
          <Trans>
            The Education subscription gives access to AirStudio's Game
            Development curriculum. Co-created with teachers and institutions,
            itâ€™s a ready-to-use, proven way to implement STEM in your classroom.
          </Trans>
        </Text>
          ...
          <ResponsiveLineStackLayout noColumnMargin noMargin>
            <div style={styles.buttonContainer}>
              <FlatButton
                ...
                fullWidth
                onClick={() => {
                  Window.openExternalURL('https://AirStudio.io/education');
                }}
                ...
                >
                  <ColumnStackLayout alignItems="flex-start" noMargin>
                    <div
                      style={{
                        ...styles.freeTag,
                        color: airStudioTheme.statusIndicator.success,
                        borderColor: airStudioTheme.statusIndicator.success,
                      }}
                    >
                    ...
                    <Text>
                      <Trans>
                        Receive a copy of AirStudioâ€™s teaching resources:
                        <li>Extract of our ready-to-teach Curriculum</li>
                        <li>
                          Poster with AirStudio's core concepts to use in your
                          classroom
                        </li>
                        <li>â€œGame Development as an Educational wonderâ€ PDF</li>
                      </Trans>
                    </Text>
