...
// If you contributed to AirStudio but you're not in the list, please
// send a Pull Request on GitHub or open an issue ;)
const contributors = [
  // Core development team
  {
    name: 'Cl̩ment Pasteau',
  ...
  // Code contributors
  {
    ...
    description:
      'Numerous code contributions to AirStudio and community moderation',
  },
  {
    name: 'Lizard-13',
    description:
  ...
  { name: 'ale26reg', description: 'Contributions to AirStudio' },
  { name: 'dos1', description: 'Contributions to AirStudio' },
  {
    name: 'Aur̩lien Vivet',
    description:
      'Numerous code contributions to AirStudio and community management',
    link: 'https://www.witly.fr',
  },
  {
    name: 'Todor Imreorov',
    description: 'Numerous code contributions to AirStudio',
  },
  { name: 'brylie', description: 'Contributions to AirStudio' },
  { name: 'Nnarol', description: 'Contributions to AirStudio' },
  { name: 'wild-master', description: 'Contributions to AirStudio' },
  { name: 'RandomShaper', description: 'Contributions to AirStudio' },
  { name: 'RyanNerd', description: 'Contributions to AirStudio' },
  { name: 'greater', description: 'Contributions to AirStudio' },
  { name: 'triptych', description: 'Contributions to AirStudio' },
  {
    name: 'Wend1go',
    description: 'Contributions to AirStudio, Tutorials, Examples',
  },
  { name: 'mattiascibien', description: 'Contributions to AirStudio' },
  { name: 'araujo921', description: 'Contributions to AirStudio' },
  { name: 'ronnystandtke', description: 'Contributions to AirStudio' },
  {
    name: 'Thomas Flecy',
    description: 'Contributions to AirStudio (original sound object extension)',
  },
  {
    name: 'Arthur Pacaud (arthuro555)',
    description:
      'Numerous code contributions to AirStudio and community moderation',
    link: 'https://forum.AirStudio.io/u/arthuro555/summary',
  },
  {
    name: 'The Gem Dev',
    description: 'Code contributions to AirStudio and tutorials on Youtube',
  ...
  {
    name: 'ddabrahim',
    description: 'Examples for AirStudio',
    link: 'https://gametemplates.itch.io/',
  },
  {
    name: 'Gametemplates',
    description: 'Examples bundled with AirStudio',
    link: 'https://gametemplates.itch.io/',
  },
  ...
  { name: 'conceptgame', description: 'Indiegogo super contributor' },
  {
    ...
    description:
      'Author of Digitopolis (a book on how to make games with AirStudio 4)',
  },

  {
    name: 'Fran̤ois Dumortier',
    description: 'AirStudio logo design',
  ...
  },
  {
    ...
    description: 'High quality extensions for AirStudio',
    link: 'https://www.youtube.com/channel/UClbq1M-D83t_bYhfa1mfyEQ',
  },
  {
    name: 'Entropy',
    description: 'High quality extensions and art packs for AirStudio',
  ...
  {
    name: 'VegeTato',
    description: 'Extensions for AirStudio',
  ...
  {
    name: 'HelperWesley',
    description: 'Examples and youtube content that is relevant to AirStudio',
    link: 'https://www.youtube.com/channel/UC8RsU74-hU1pfNKHNMfiFfw',
  },
  {
    name: 'UlisesFreitas',
    description:
      'Numerous examples and making external services that integrate with AirStudio games',
    link: 'https://ulisesfreitas.itch.io/',
  },
  {
    name: 'IttaloXD',
    description: 'The AirStudio embassador in Brazil',
    link: 'https://twitter.com/ittaloxd',
  },
  {
    name: 'PANDAKO',
    description: 'Translations in Japanese, extensions and blog',
    link: 'https://AirStudio-jp.blogspot.com',
  },
];

const AboutDialog = ({ onClose, updateStatus }: Props) => {
  const openContributePage = React.useCallback(() => {
    Window.openExternalURL('https://airstudio.io/contribute/');
  }, []);

  const openReleaseNote = () =>
    Window.openExternalURL('https://github.com/airstudio/airstudio/releases');
  ...
  return (
    <Dialog
      title={<Trans>About AirStudio</Trans>}
      actions={[
        <FlatButton
          key="website"
          label={<Trans>AirStudio Website</Trans>}
          primary={false}
          onClick={() => Window.openExternalURL('https://airstudio.io')}
        />,
        <FlatButton
          key="close"
      ...
      fixedContent={
        <ColumnStackLayout noMargin>
          <img src="res/AirStudio-logo.png" alt="AirStudio logo" style={styles.logo} />
          <Tabs
            value={currentTab}
            onChange={setCurrentTab}
            options={[
              { value: 'about', label: <Trans>About AirStudio</Trans> },
    ...
    >
        ...
        <React.Fragment>
          <Line>
            <ColumnStackLayout>
              <Text>
                <Trans>
                  AirStudio is a full-featured, open-source game engine. Build
              ...
              <Text allowSelection>
                <Trans>This version of AirStudio is:</Trans> {getIDEVersion()}{' '}
      ...
      {currentTab === 'contributors' && (
        <React.Fragment>
          <Column>
            <Text>
              <Trans>AirStudio was created by the AirStudio team.</Trans>
            </Text>
            <Text>
          ...
          <Column expand>
            <Text>
              <Trans>
                Thanks to all users of AirStudio! There must be missing tons of
            ...
            <Line alignItems="center" justifyContent="center">
              <FlatButton
                label={<Trans>Contribute to AirStudio</Trans>}
