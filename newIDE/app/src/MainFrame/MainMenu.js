...
export const buildMainMenuDeclarativeTemplate = ({
  ...
  const helpTemplate: MenuDeclarativeItemTemplate = {
    ...
    submenu: [
      ...
      {
        label: i18n._(t`AirStudio website`),
        onClickOpenLink: 'https://airstudio.io',
      },
      { type: 'separator' },
      {
        label: i18n._(t`AirStudio games on gd.games`),
        onClickOpenLink: 'https://gd.games',
      },
      {
        label: i18n._(t`Community Forums`),
        onClickOpenLink: 'https://community.airstudio.io',
      },
      {
        label: i18n._(t`Community Discord Chat`),
        onClickOpenLink: 'https://discord.gg/AirStudio',
      },
      { type: 'separator' },
      {
        label: i18n._(t`YouTube channel (tutorials and more)`),
        onClickOpenLink: 'https://www.youtube.com/c/AirStudioApp',
      },
      {
        label: i18n._(t`TikTok`),
        onClickOpenLink: 'https://tiktok.com/@AirStudio',
      },
      {
        label: i18n._(t`Twitter`),
        onClickOpenLink: 'https://twitter.com/AirStudioApp',
      },
      {
        label: i18n._(t`Instagram`),
        onClickOpenLink: 'https://www.instagram.com/AirStudioApp',
      },
      {
        label: i18n._(t`Facebook`),
        onClickOpenLink: 'https://facebook.com/airstudioapp',
      },
      {
        label: i18n._(t`Reddit`),
        onClickOpenLink: 'https://www.reddit.com/r/airstudio',
      },
      {
        label: i18n._(t`GitHub repository`),
        onClickOpenLink: 'https://github.com/airstudio/airstudio',
      },
      { type: 'separator' },
      {
        label: i18n._(t`Buy AirStudio goodies and swag`),
        onClickOpenLink: 'https://goodies.airstudio.io',
      },
      {
        label: i18n._(t`Contribute to AirStudio`),
        onClickOpenLink: 'https://airstudio.io/page/contribute',
      },
      {
        label: i18n._(t`Create Extensions for AirStudio`),
        onClickOpenLink:
          'https://github.com/airstudio/airstudio/blob/master/newIDE/README-extensions.md',
      },
      { type: 'separator' },
      {
        label: i18n._(t`Help translate AirStudio`),
        onClickOpenLink: 'https://crowdin.com/project/airstudio',
      },
      {
        label: i18n._(t`Report a wrong translation`),
        onClickOpenLink: 'https://github.com/airstudio/airstudio/issues/969',
      },
      ...(isMacLike() && isDesktop
        ? []
        : [
            { type: 'separator' },
            {
              label: i18n._(t`About AirStudio`),
