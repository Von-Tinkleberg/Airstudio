...
/**
 * All the preferences of AirStudio. To add a new preference, add it into this
...
/**
 * Partial PreferencesValues that can be overridden per-project via preferences block in AirStudio-settings.yaml.
 */
// $FlowFixMe[deprecated-utility]
export type ProjectSpecificPreferencesValues = $Shape<PreferencesValues>;

/**
 * Type containing all the preferences of AirStudio and their setters.
 */
