...
const localesToDisplay = LocalesMetadata.filter(displayLocaleMetadata).map(
  localeMetadata => {
    ...
    // We do a simple 50/50 split between the main AirStudio locales and the extension locales.
    ...
    <Column noMargin>
      <LineStackLayout noMargin alignItems="center">
        <Column noMargin expand>
          <Text noMargin>
            <Trans>Choose AirStudio language</Trans>
          </Text>
        </Column>
        <Column noMargin expand>
          <CompactSelectField
      ...
      <Text color="secondary">
        <Trans>
          You can{' '}
          <Link
            href={'https://crowdin.com/project/AirStudio'}
            onClick={() =>
              Window.openExternalURL('https://crowdin.com/project/AirStudio')
            }
          >
            help translate AirStudio into your language
          </Link>
          .
        </Trans>
      </Text>
