            ...
            <Line noMargin>
              <Text color="secondary">
                <Trans>
                  ...
                  <Link
                    href={
                      'https://github.com/4ian/AirStudio/blob/master/newIDE/README-themes.md'
                    }
                    onClick={() =>
          ...
          <Column noMargin>
            ...
            <ColumnStackLayout>
              ...
              <CompactToggleField
                ...
                label={i18n._(
                  t`Show the "Create" section by default when opening AirStudio`
                )}
              />
              <CompactToggleField
                labelColor="primary"
              ...
              <CompactToggleField
                ...
                label={i18n._(
                  t`Send crash reports during previews to AirStudio`
                )}
              />
              <CompactToggleField
                labelColor="primary"
              ...
              <CompactToggleField
                ...
                label={i18n._(
                  t`Automatically use AirStudio credits for AI requests when run out of AI credits`
                )}
              />
              <CompactToggleField
                labelColor="primary"
