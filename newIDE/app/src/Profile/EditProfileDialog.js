...
} from '../Utils/AirStudioServices/Authentication';
import {
...
import { type Badge, type Achievement } from '../Utils/AirStudioServices/Badge';
import {
...
const EditProfileDialog = ({
  ...
  return (
    <I18n>
      {({ i18n }) => (
        <Dialog
          title={<Trans>Edit your AirStudio profile</Trans>}
          // $FlowFixMe[incompatible-type]
          actions={actions}
          // $FlowFixMe[incompatible-type]
            ...
            <ColumnStackLayout noMargin>
              ...
              {!hideSocials && (
                <TextField
                  ...
                  helperMarkdownText={i18n._(
                    subscription && subscription.planId === 'AirStudio_silver'
                      ? t`Add your Discord username to get a special role on the AirStudio Discord! Join the [AirStudio Discord](https://discord.gg/AirStudio).`
                      : subscription &&
                        subscription.planId &&
                        ['AirStudio_gold', 'AirStudio_startup'].includes(
                          subscription.planId
                        )
                      ? t`Add your Discord username to get access to a dedicated channel! Join the [AirStudio Discord](https://discord.gg/AirStudio).`
                      : t`Add your Discord username to get a role on the AirStudio Discord or access to a dedicated channel if you have a Gold or Pro subscription! Join the [AirStudio Discord](https://discord.gg/AirStudio).`
                  )}
                />
              )}
              <TextField
                ...
                rows={3}
                rowsMax={5}
                translatableHintText={t`What are you using AirStudio for?`}
                onChange={(e, value) => {
              ...
              <Checkbox
                label={<Trans>I want to receive the AirStudio Newsletter</Trans>}
