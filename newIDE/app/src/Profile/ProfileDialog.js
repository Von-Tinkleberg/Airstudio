...
import { getRedirectToSubscriptionPortalUrl } from '../Utils/AirStudioServices/Usage';
...
import { markBadgesAsSeen as doMarkBadgesAsSeen } from '../Utils/AirStudioServices/Badge';
  ...
  const onManageSubscription = React.useCallback(
    async () => {
      ...
      try {
        ...
        showErrorBox({
          message:
            'Unable to load the portal to manage your subscription. Please contact us on billing@AirStudio.io',
          rawError: error,
                  ...
                  <Column noMargin>
                    ...
                    <Text size="body" noMargin>
                      <Trans>
                        ...
                        game launch.{' '}
                        <Link
                          href="https://wiki.AirStudio.io/AirStudio5/interface/profile/credits"
                          onClick={() =>
                            Window.openExternalURL(
                              'https://wiki.AirStudio.io/AirStudio5/interface/profile/credits'
                            )
                          }
                        >
                          Learn more
