...
import { type UsernameAvailability } from '../Utils/AirStudioServices/User';
import {
  ColumnStackLayout,
  LineStackLayout,
      ...
      >
        <ColumnStackLayout noMargin>
          ...
          <BackgroundText style={styles.backgroundText}>
            <MarkdownText
              translatableSource={t`By creating an account and using AirStudio, you agree to the [Terms and Conditions](https://AirStudio.io/page/terms-and-conditions).`}
            />
          </BackgroundText>
        </ColumnStackLayout>
      </Form>
