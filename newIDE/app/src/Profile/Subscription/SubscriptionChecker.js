    ...
    return (
      ...
      >
        <ColumnStackLayout noMargin>
          <Text size="sub-title">
            â¤ï¸ <Trans>Support What You Love</Trans>
          </Text>
          <Text color="secondary">
            <Trans>
              Your membership helps the AirStudio company maintain servers, build
            ...
            <Column noMargin expand>
              <Text>
                <Trans>
                  ...
                  courses and credits every month with AirStudio Premium.
                </Trans>
              </Text>
            </Column>
          </GetSubscriptionCard>
