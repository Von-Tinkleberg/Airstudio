      ...
      <Column noMargin>
        ...
        <Text size="body" noMargin>
          <Trans>
            ...
            <Link
              href="https://AirStudio.io/pricing#feature-comparison"
              onClick={() =>
                Window.openExternalURL(
                  'https://AirStudio.io/pricing#feature-comparison'
                )
              }
            >
              Learn more
      ...
      !isSubscriptionExpired ? (
            ...
            >
              <Column expand noMargin>
                <LineStackLayout alignItems="center">
                  ...
                  <Text noMargin>
                    <Trans>
                      You have unlocked full access to AirStudio to create
                      without limits!
                    </Trans>
                  </Text>
                </LineStackLayout>
                  ...
                  onClick={() => {
                    if (hasMobileAppStoreSubscriptionPlan(subscription)) {
                      ...
                      showAlert({
                        ...
                        message: t`The subscription of this account comes from outside the app store. Connect with your account on editor.AirStudio.io from your web-browser to manage it.`,
                      });
                    }
                  }}
                />
        ...
        isOnOrSimulateMobileApp ? (
          ...
          >
            <Text noMargin>
              <Trans>
                Unlock full access to AirStudio to create without limits!
              </Trans>
            </Text>
          </GetSubscriptionCard>
        ) : (
