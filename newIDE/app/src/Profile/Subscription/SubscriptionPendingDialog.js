...
import { discordUsernameConfig } from '../../Utils/AirStudioServices/User';
          ...
          {!hasUserPlanChanged ? (
            <Column noMargin>
              <Line expand alignItems="center" justifyContent="center">
                <Text>
                  <Trans>
                    Thanks for getting a subscription and supporting AirStudio!
                  </Trans>{' '}
                  {'ðŸ’œ'}
                </Text>
              </Line>
              ...
              <Line justifyContent="center">
                <BackgroundText>
                  <Trans>
                    Once you're done, come back to AirStudio and your account
