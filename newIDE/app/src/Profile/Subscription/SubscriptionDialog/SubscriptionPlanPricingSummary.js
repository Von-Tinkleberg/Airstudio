        ...
        <div className={classes.choosePlanContainer}>
          <Paper background="dark" style={styles.paper}>
            <ColumnStackLayout>
              ...
              {subscriptionPlanWithPricingSystems.id === 'AirStudio_education' &&
                !onlyShowDiscountedPrice && (
                    ...
                    <SemiControlledTextField
                      ...
                      helperMarkdownText={
                        !isUserCurrentOrLegacyPlan
                          ...
                          : i18n._(t`Contact us at education@AirStudio.io if you want to update
                      your plan`)
                      }
                    />
                  </ColumnStackLayout>
              ...
              {!onlyShowDiscountedPrice &&
                !(
                  subscriptionPlanWithPricingSystems.id ===
                    'AirStudio_education' && isUserCurrentOrLegacyPlan
                ) && (
                              ...
                              userPricingSystem.period === 'year' ? (
                                ...
                                <span
                                  style={{
                                    ...styles.discountOrOwnedContainer,
                                    backgroundColor:
                                      airStudioTheme.message.hot.backgroundColor,
                                    color: airStudioTheme.message.hot.color,
                                  }}
                                >
