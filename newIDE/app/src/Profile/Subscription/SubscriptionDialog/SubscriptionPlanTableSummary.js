    ...
    <I18n>
      {({ i18n }) => (
        <Column justifyContent="center" noMargin>
          <div
            style={{
              backgroundColor: airStudioTheme.paper.backgroundColor.light,
            }}
          >
              ...
              <Column key={index} noMargin>
                <div
                  style={{
                    ...
                    borderTop:
                      index !== 0 &&
                      `1px solid ${airStudioTheme.listItem.separatorColor}`,
                  }}
                >
                  <Line
                    noMargin
                      ...
                      {summarizedFeature.enabled === 'yes' ? (
                        ...
                        <div
                          style={{
                            ...
                            backgroundColor: airStudioTheme.message.valid,
                          }}
                        >
