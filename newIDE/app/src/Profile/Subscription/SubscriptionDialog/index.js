  ...
  return (
    <I18n>
      {({ i18n }) => (
        <>
          <Dialog
            title={<Trans>Get AirStudio Premium</Trans>}
            subtitle={
              <Trans>
                  ...
                  <ColumnStackLayout noMargin>
                    <Column noMargin>
                      ...
                      <Text size="body" color="secondary">
                        <Trans>
                          The AirStudio project is open-source, powered by
                          passion and community. Your membership helps the
                          AirStudio company maintain servers, build new features,
