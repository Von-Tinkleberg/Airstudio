...
import { AirStudioGamesPlatform } from '../Utils/AirStudioServices/ApiConfigs';
...
import {
  ...
  syncDiscordUsername,
  syncForumGroup,
} from '../Utils/AirStudioServices/User';
...
import { canBenefitFromSocialRole } from '../Utils/AirStudioServices/Usage';
      ...
      try {
        ...
        if (
          ...
          showAlert({
            ...
            message: t`Ensure you don't have any typo in your username and that you have joined the AirStudio Discord server.`,
          });
          return;
        }
        showAlert({
        ...
        if (
          ...
          showAlert({
            ...
            message: t`No forum account was found with email ${email ||
              ''}. Make sure you have created an account on the AirStudio forum with this email.`,
          });
          return;
        }
        showAlert({
                  ...
                  <LineStackLayout noMargin alignItems="center">
                    ...
                    {canUserBenefitFromSocialRole && !!discordUsername && (
                      <IconButton
                        ...
                        tooltip={t`Sync your role on AirStudio's Discord server`}
                        size="small"
                      >
                  ...
                  <Text color={!discordUsername ? 'secondary' : 'primary'}>
                    {!discordUsername ? (
                      !canUserBenefitFromSocialRole ? (
                        <MarkdownText
                          translatableSource={t`Get access to an exclusive channel on the [AirStudio Discord](https://discord.gg/AirStudio) by subscribing to a Gold, Pro or Education plan.`}
                        />
                      ) : (
                        <MarkdownText
                          translatableSource={t`Edit your profile and fill your discord username to claim your role on the [AirStudio Discord](https://discord.gg/AirStudio).`}
                        />
                      )
                    ) : (
                      <>
                        ...
                        {!canUserBenefitFromSocialRole && (
                          <>
                            {' - '}
                            <MarkdownText
                              translatableSource={t`Get a Gold or Pro subscription to claim your role on the [AirStudio Discord](https://discord.gg/AirStudio).`}
                            />
                          </>
                        )}
                      </>
                  ...
                  <Column noMargin>
                    <LineStackLayout noMargin alignItems="center">
                      ...
                      <IconButton
                        ...
                        tooltip={t`Sync your subscription level on AirStudio's forum`}
                        size="small"
                      >
              ...
              <FlatButton
                ...
                onClick={() =>
                  Window.openExternalURL(
                    AirStudioGamesPlatform.getUserPublicProfileUrl(
                      profile.id,
                      profile.username
                    )
                  )
