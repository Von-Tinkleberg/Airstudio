...
const CurrentUsageDisplayer = ({
  ...
  const remainingMultipleMessage =
    quota.period === '30days' ? (
      <Trans>
        You have <b>{remainingBuilds}</b> builds remaining â€” you have used
  ...
  const remainingSingleMessage =
    quota.period === '30days' ? (
      <Trans>
        You have <b>{remainingBuilds}</b> build remaining â€” you have used
        {usageRatio} in the past 30 days.
      </Trans>
    ) : (
      <Trans>
        ...
        !quota.limitReached ? (
          <div
            style={{
              ...
              border: `1px solid ${airStudioTheme.palette.secondary}`,
            }}
          >
            <img
              src="res/diamond.svg"
            ...
            <Line>
              {!isFeatureLocked ? (
                <Column noMargin>
                  ...
                  <Text noMargin>
                    {cannotUpgradeSubscription ? (
                      <Trans>Use AirStudio credits to start an export.</Trans>
                    ) : (
                      <Trans>
                        Use AirStudio credits or upgrade your subscription to
                        increase the limits.
                      </Trans>
                    )}
                  </Text>
                ...
                <Column noMargin>
                  <Text noMargin>
                    <Trans>
                      Upgrade your AirStudio subscription to unlock this
                      packaging.
                    </Trans>
                  </Text>
                </Column>
            ...
            {!isFeatureLocked ? (
              <Column noMargin>
                ...
                <Text noMargin>
                  {quota.limitReached ? (
                    <Trans>
                      Use AirStudio credits or get a subscription to increase the
                      limits.
                    </Trans>
                  ) : (
                    <Trans>
                      Get a AirStudio subscription to increase the limits.
                    </Trans>
                  )}
                </Text>
              </Column>
