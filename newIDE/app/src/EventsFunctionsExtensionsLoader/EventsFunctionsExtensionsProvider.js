    ...
    (project: ?gdProject): Promise<void> => {
      ...
      const currentPromise: Promise<void> = previousLastLoadPromise
        ...
        .catch((eventsFunctionsExtensionsError: Error) => {
          ...
          showErrorBox({
            message: i18n._(
              t`An error has occurred during functions generation. If AirStudio is installed, verify that nothing is preventing AirStudio from writing on disk. If you're running AirStudio online, verify your internet connection and refresh functions from the Project Manager.`
            ),
