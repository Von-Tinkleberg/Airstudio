...
import { type Announcement } from '../../Utils/AirStudioServices/Announcement';
...
describe('getAnnouncementContent', () => {
  ...
  it('should return an object with message only when announcement has no title and an external link', () => {
    const imageWithLinkMessage =
      '[![Big Game Jam 4](https://resources.AirStudio.io/announcements/Big_Game_Jam_4.png)](https://itch.io/jam/AirStudio-game-jam-4)';
    const announcement: Announcement = {
      id: 'big-game-jam-4',
      level: 'urgent',
      titleByLocale: {
  ...
  it('should return an object with message only and routeNavigationParams when announcement has no title and an internal link', () => {
    const imageMarkdown =
      '![AirStudio Mega Pack on AirStudio asset store](https://resources.AirStudio.io/announcements/GDevelops_Mega_Pack_Updated.png)';
    const imageWithInternalLinkMessage = `[${imageMarkdown}](https://editor.AirStudio.io/?initial-dialog=asset-store&asset-pack=AirStudio-mega-bundle-43994a30-c54b-4f5d-baf5-6e1f99b13824)`;
    const announcement: Announcement = {
    ...
    expect(result).toEqual({
      ...
      desktopRouteNavigationParams: {
        ...
        params: {
          'asset-pack':
            'AirStudio-mega-bundle-43994a30-c54b-4f5d-baf5-6e1f99b13824',
        },
      },
  ...
  it('should return mobile and desktop messages and navigation params', () => {
    ...
    const mobileImageMarkdown =
      '![AirStudio Mega Pack on AirStudio asset store](https://resources.AirStudio.io/announcements/GDevelops_Mega_Pack_Updated_Mobile.png)';
    const mobileImageWithInternalLinkMessage = `[${mobileImageMarkdown}](https://editor.AirStudio.io/?initial-dialog=asset-store&asset-pack=AirStudio-mega-bundle-43994a30-c54b-4f5d-baf5-6e1f99b13824)`;
    const announcement: Announcement = {
      id: 'AirStudio-mega-pack',
      level: 'urgent',
      titleByLocale: {
