...
const filesToDownload: { [FileSet]: Array<string> } = {
  ...
  web: ['/Runtime/index.html', '/Runtime/Electron/LICENSE.AirStudio.txt'],
  'cocos2d-js': [
  ...
  cordova: [
    ...
    '/Runtime/Cordova/www/LICENSE.AirStudio.txt',
  ...
  electron: [
    ...
    '/Runtime/Electron/LICENSE.AirStudio.txt',
  ],
};
...
|}> => {
  ...
  let gdjsRoot = `https://resources.AirStudio-app.com/GDJS-${getIDEVersionWithHash()}`;
