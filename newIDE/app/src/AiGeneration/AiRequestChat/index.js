...
const actionsOnExistingProject = [
  ...
  t`What is a good AirStudio feature I could use in my game?`,
...
export const AiRequestChat: React.ComponentType<{
  ...
  (
    ...
    const progressBarColor =
      airStudioTheme.palette.type === 'light' ? '#7046EC' : '#9979F1';
    const progressTrackColor =
      airStudioTheme.palette.type === 'light' ? '#D9D9DE' : '#32323B';
    ...
    const [
      hasSwitchedToAirStudioCreditsMidChat,
      setHasSwitchedToAirStudioCreditsMidChat,
    ] = React.useState<boolean>(false);
      ...
      onOpenSubscriptionDialog: () =>
        openSubscriptionDialog({
          analyticsMetadata: {
            ...
            recommendedPlanId: 'AirStudio_gold',
    ...
    const shouldReplaceFormWithCreditsOrSubscriptionPrompt =
      ...
      // automatically switched to AirStudio credits.
      hasStartedRequestButCannotContinue &&
      // If the user accepts to switch to AirStudio credits, then we hide it,
      // except if they still cannot continue because they don't have enough AirStudio credits.
      (!hasSwitchedToAirStudioCreditsMidChat ||
        doesNotHaveEnoughCreditsToContinue) &&
                            ...
                            <Column noMargin>
                              <Text>
                                {!automaticallyUseCreditsForAiRequests ? (
                                  ...
                                  <Trans>
                                    You've ran out of AirStudio Credits.
                                  </Trans>
                                )}
                              </Text>
                              <Text>
                                {!automaticallyUseCreditsForAiRequests ? (
                                  <Trans>
                                    Switch to AirStudio credits or keep building
                                    with AI.
                                  </Trans>
                                  ...
                                  <Trans>
                                    Get more AirStudio credits to keep building
                                    with AI.
                                  </Trans>
                                )}
                              </Text>
                          ...
                          {!automaticallyUseCreditsForAiRequests ? (
                            <FlatButton
                              ...
                              onClick={() => {
                                ...
                                setHasSwitchedToAirStudioCreditsMidChat(true);
                              }}
                              label={<Trans>Use AirStudio Credits</Trans>}
                              noBackground
                            />
