...
// consistent across React re-renders (same plan â†’ same phrase).
const PLAN_INTRO_PHRASES = [
  t`I've mapped out a plan â€” here's what I'll do:`,
  t`Alright, here's my approach:`,
  t`I've broken this into steps â€” let me walk you through it:`,
  t`Here's how I'll tackle this:`,
  t`Got it! I've put together a plan:`,
  t`Let me lay out the steps:`,
  t`I've thought this through â€” here's the plan:`,
];
    ...
    case 'done':
      return (
        <div className={classes.statusIconFixed}>
          <Check fontSize="small" htmlColor={airStudioTheme.message.valid} />
        </div>
      );
    case 'in_progress':
      return (
...
export const OrchestratorPlan = ({
  ...
  // stable across React re-renders (same plan message â†’ same phrase).
