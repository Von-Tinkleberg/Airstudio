      ...
      <div className={classes.functionCallRow}>
        ...
        >
          <span className={classes.statusIconContainer}>
            {hasErrored ? (
              <Error htmlColor={airStudioTheme.message.error} fontSize="small" />
            ) : isAborted ? (
              <Error
                htmlColor={airStudioTheme.text.color.disabled}
                fontSize="small"
              />
            ) : isFinished ? (
              <Check htmlColor={airStudioTheme.message.valid} fontSize="small" />
            ) : (
              <CircularProgress
                size={16}
                value={100}
      ...
      {newlyAddedResourcesNames && newlyAddedResourcesNames.length > 0 && (
        <div className={classes.addedResourcesContainer}>
          <LineStackLayout noMargin alignItems="center">
            <CircledAdd
              fontSize="small"
              htmlColor={airStudioTheme.message.valid}
            />
