...
import { canUpgradeSubscription } from '../../Utils/AirStudioServices/Usage';
...
type Props = {|
  ...
  onSwitchedToAirStudioCredits: () => void,
    ...
    const suggestedSubscriptionPlanWithPricingSystem = React.useMemo(
      () => {
        ...
        const goldPlan = subscriptionPlansWithPricingSystems.find(
          plan => plan.id === 'AirStudio_gold'
        );
        const proPlan = subscriptionPlansWithPricingSystems.find(
          plan => plan.id === 'AirStudio_startup'
        );
        return (
          (subscription && subscription.planId === 'AirStudio_gold'
            ? proPlan
          ...
          if (message.type === 'message' && message.role === 'user') {
            ...
            message.content.forEach((messageContent, messageContentIndex) => {
              if (messageContent.type === 'function_call') {
                ...
                // Don't display function calls with a taskId here â€” they are
      ...
      () => {
        ...
        items.forEach((item, index) => {
          if (item.type === 'orchestrator_plan') {
            ...
            // A real message resets the sequence â€” plans after it are independent.
            lastPlanIndex = -1;
          }
        });
          ...
          <Line justifyContent="center">
            ...
            >
                  ...
                  <Text>
                    {!!subscription ? (
                      <Trans>
                        ...
                        requests and AirStudio coins to unlock the engine's extra
                        benefits.
                      </Trans>
                    ) : (
                      <Trans>
                        Get a Premium subscription to have more AI requests and
                        AirStudio coins to unlock the engine's extra benefits.
                      </Trans>
                    )}
                  </Text>
              ...
              <ColumnStackLayout noMargin>
                {suggestedSubscriptionPlanWithPricingSystem ? (
                  <Text size="sub-title">
                    <Trans>You can switch to AirStudio credits.</Trans>
                  </Text>
                ) : (
                  <ColumnStackLayout noMargin>
                    <Line>
                    ...
                    <Text size="block-title" noMargin>
                      <Trans>
                        You've ran out of AirStudio credits to continue this
                        conversation.
                      </Trans>
                    </Text>
                  </ColumnStackLayout>
                ...
                <Text noMargin color="secondary">
                  {availableCredits > 0 ? (
                    ...
                    <Trans>
                      ...
                      AirStudio credits to continue making AI requests.
                    </Trans>
                  )}
                </Text>
                <Line noMargin>
                  ...
                  <FlatButton
                    ...
                    label={
                      automaticallyUseCreditsForAiRequests ? (
                        <Trans>Using AirStudio Credits</Trans>
                      ) : (
                        <Trans>Switch to AirStudio Credits</Trans>
                      )
                    }
