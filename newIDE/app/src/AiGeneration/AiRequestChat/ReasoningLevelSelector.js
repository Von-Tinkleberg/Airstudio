...
const getSubscriptionBadge = (
  ...
  if (
    enabledWithPlans.some(
      p => p === 'AirStudio_silver' || p === 'AirStudio_indie'
    )
  ) {
    return <Silver style={styles.subscriptionIcon} />;
  }
  if (enabledWithPlans.some(p => p === 'AirStudio_gold')) {
...
export const ReasoningLevelSelector = ({
  ...
  const orchestratorPresets = React.useMemo(
    () =>
