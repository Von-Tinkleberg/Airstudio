        ...
        marketingPlansError || gameFeaturingsError ? (
          ...
          <ColumnStackLayout noMargin>
            <Text color="secondary" noMargin>
              <Trans>
                Make your game visible to the AirStudio community and to the
                world with Marketing Boosts.{' '}
                <Link
                  href="https://docs.airstudio.io/AirStudio5/interface/games-dashboard/marketing"
                  onClick={() =>
                    Window.openExternalURL(
                      'https://docs.airstudio.io/AirStudio5/interface/games-dashboard/marketing'
                    )
                  }
                >
                  Read more
