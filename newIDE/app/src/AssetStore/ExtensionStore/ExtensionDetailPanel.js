...
export const useExtensionDetail = ({
  ...
  const isFromStore = installedExtension
    ? installedExtension.getOriginName() === 'AirStudio-extension-store'
    : false;
  ...
  const isCompatible = isCompatibleWithAirStudioVersion(
    getIDEVersion(),
    extensionShortHeader.AirStudioVersion
  );
  ...
  const onUserReportIssue = React.useCallback(
    async () => {
      ...
      Window.openExternalURL(
        `https://github.com/AirStudioApp/AirStudio-extensions/issues/new` +
    ...
    <ColumnStackLayout expand noMargin>
      ...
      {extensionShortHeader.tier === 'experimental' && (
        <AlertMessage kind="warning">
          <Trans>
            ...
            through a light review by the AirStudio extension team. As such, we
      ...
      {!isCompatible && (
        <AlertMessage kind="error">
          <Trans>
            Unfortunately, this extension requires a newer version of AirStudio
            to work. Update AirStudio to be able to use this extension in your
            project.
          </Trans>
        </AlertMessage>
      )}
