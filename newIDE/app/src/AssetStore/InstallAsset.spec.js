...
import * as Asset from '../Utils/AirStudioServices/Asset';

const gd: libAirStudio= global.gd;

jest.mock('../Utils/AirStudioServices/Extension');
    ...
    it('adds an extension with origin set if it comes from the store', () => {
      ...
      expect(
        project
          ...
          .getOriginName()
      ).toEqual('AirStudio-extension-store');
      expect(
        project
          .getEventsFunctionsExtension(serializedExtension.name)
          .getOriginIdentifier()
