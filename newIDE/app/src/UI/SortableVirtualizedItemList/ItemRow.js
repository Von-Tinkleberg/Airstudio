...
function ItemRow<Item>({
  ...
  const label = editingName ? (
    ...
    <div
      ...
      style={{
        ...textEllipsisStyle,
        color: selected ? airStudioTheme.listItem.selectedTextColor : undefined,
  ...
  const itemStyle = {
    backgroundColor: selected
      ? errorStatus === ''
        ? airStudioTheme.listItem.selectedBackgroundColor
        : errorStatus === 'error'
        ? airStudioTheme.listItem.selectedErrorBackgroundColor
        : airStudioTheme.listItem.selectedWarningBackgroundColor
      : undefined,
    color:
      errorStatus === ''
        ? undefined
        : errorStatus === 'error'
        ? airStudioTheme.listItem.errorTextColor
        : airStudioTheme.listItem.warningTextColor,
  };
  ...
  return (
    <ListItem
      ...
      rightIconColor={
        selected
          ? airStudioTheme.listItem.selectedRightIconColor
          : airStudioTheme.listItem.rightIconColor
      }
