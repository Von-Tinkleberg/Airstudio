 ...
 * search ignores accents/diacritics (e.g. searching "camera" matches "camÃ©ra",
 * "scene" matches "scÃ¨ne"). The search query is normalized the same way (see
 ...
 * accented characters commonly used in translations (Ã©, Ã¨, Ã , Ã§â€¦), so the match
