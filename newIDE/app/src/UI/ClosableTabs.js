...
export function ClosableTab({
  ...
  const textColor = active
    ? airStudioTheme.closableTabs.selectedTextColor
    : airStudioTheme.closableTabs.textColor;

  const brightness =
    airStudioTheme.palette.type === 'dark'
      ? active
        ? 0.978
        : 0.776
      : active
    ...
    <React.Fragment>
      <span
        ...
        style={{
          ...
          borderBottom: 'none',
          borderColor: active
            ? airStudioTheme.closableTabs.selectedBorderColor
            : airStudioTheme.closableTabs.backgroundColor,
          backgroundColor: !active
            ? airStudioTheme.closableTabs.backgroundColor
            : airStudioTheme.closableTabs.selectedBackgroundColor,
        }}
        ...
        >
          <span
            style={{
              ...
              height: airStudioTheme.closableTabs.height,
              color: textColor,
              fontFamily: airStudioTheme.closableTabs.fontFamily,
            }}
          >
        ...
        {closable && (
          ...
          >
            <Cross
              style={{
                ...styles.closeButton,
                width: airStudioTheme.closableTabs.height / 2,
                height: airStudioTheme.closableTabs.height,
              }}
              htmlColor={textColor}
            />
