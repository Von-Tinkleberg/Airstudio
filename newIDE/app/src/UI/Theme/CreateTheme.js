...
export function createairStudioTheme({
  styles,
  rootClassNameIdentifier,
  paletteType,
  airStudioIconsCSSFilter,
}: {
  styles: any,
  rootClassNameIdentifier: string,
  paletteType: string,
  airStudioIconsCSSFilter: ?string,
}): any {
  return {
    airStudioTheme: {
      palette: {
      ...
      closableTabs: {
        fontFamily: styles['AirStudioModernFontFamily'],
