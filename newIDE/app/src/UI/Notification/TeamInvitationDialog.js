...
import { acceptTeamInvitation } from '../../Utils/AirStudioServices/User';
import { markNotificationsAsSeen } from '../../Utils/AirStudioServices/Notification';
  ...
  const onAccept = React.useCallback(
    async () => {
      ...
      try {
        ...
        const extractedError = extractAirStudioApiErrorStatusAndCode(err);
