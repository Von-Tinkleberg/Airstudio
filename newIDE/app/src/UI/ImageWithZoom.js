 ...
 * user chosen image**.
 * On the contrary, if you're displaying a built-in AirStudio image, coming for example from the
 * "res/" folder (i.e: a AirStudio icon), you don't need this and can use `<img>` as usual.
 */
