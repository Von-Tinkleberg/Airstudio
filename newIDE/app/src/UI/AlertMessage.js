...
const AlertMessage = ({
  ...
  if (kind === 'error' || kind === 'warning' || kind === 'valid') {
    paperStyle.borderColor = airStudioTheme.message[kind];
    if (theme.palette.type === 'light') {
      paperStyle.backgroundColor = lighten(airStudioTheme.message[kind], 0.9);
    }
  }
                    ...
                    <React.Fragment>
                      ...
                      {kind === 'warning' && (
                        <WarningFilled
                          style={{
                            ...styles.icon,
                            color: airStudioTheme.message.warning,
                          }}
                        />
                      )}
                      {kind === 'error' && (
                        <ErrorFilled
                          style={{
                            ...styles.icon,
                            color: airStudioTheme.message.error,
                          }}
                        />
                      )}
                      {kind === 'valid' && (
