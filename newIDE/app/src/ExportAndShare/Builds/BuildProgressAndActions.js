...
import { type Game, updateGame } from '../../Utils/AirStudioServices/Game';
...
import { shortenUuidForDisplay } from '../../Utils/AirStudioServices/Play';
...
const BuildProgressAndActions = ({
  ...
  // inviting the user to upgrade AirStudio to learn more.
                      ...
                      return (
                        ...
                        >
                          {config ? (
                            ...
                            <Text noMargin allowSelection>
                              <Trans>
                                Upgrade AirStudio to learn more about this error.
                              </Trans>{' '}
                              ({code})
                            </Text>
                          )}
