...
import { signingCredentialApi } from '../../../Utils/AirStudioServices/Build';
  ...
  return (
    <ColumnStackLayout noMargin>
      ...
      <MarkdownText
        isStandaloneText
        allowParagraphs
        translatableSource={t`Download the certificate file (.cer) generated by Apple and upload it here. AirStudio will keep it securely stored.`}
      />
