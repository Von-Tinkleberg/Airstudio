...
import { getBaseUrl } from '../../../Utils/AirStudioServices/Preview';
...
import { getAirStudioResourceJwtToken } from '../../../Utils/AirStudioServices/Project';
...
> {
  ...
  launchPreview = async (previewOptions: PreviewOptions): Promise<any> => {
    ...
    try {
      ...
      previewExportOptions.setAirStudioVersionWithHash(getIDEVersionWithHash());
      ...
      // The token, if any, to be used to read resources on AirStudio Cloud buckets.
      const airStudioResourceToken = getAirStudioResourceJwtToken();
      if (airStudioResourceToken)
        previewExportOptions.setairStudioResourceToken(airStudioResourceToken);
