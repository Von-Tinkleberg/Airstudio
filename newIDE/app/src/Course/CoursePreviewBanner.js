...
import type { Course, CourseChapter } from '../Utils/AirStudioServices/Asset';
import {
  ColumnStackLayout,
  LineStackLayout,
...
const styles = {
  ...
  chip: { height: 24 },
  airStudioAvatar: { width: 20, height: 20 },
              ...
              >
                ...
                >
                  ...
                  <LineStackLayout noMargin alignItems="center">
                    <Avatar
                      src="./res/AirStudio-logo-b-w.png"
                      style={styles.airStudioAvatar}
                    />
                    <Text noMargin>AirStudio</Text>
                  </LineStackLayout>
                  {course ? (
                    <img
                      ...
                      <LineStackLayout alignItems="center" noMargin>
                        <div
                          style={{
                            ...
                            color: airStudioTheme.text.color.secondary,
                          }}
                        >
                          {badgeUrl ? (
                            <img
