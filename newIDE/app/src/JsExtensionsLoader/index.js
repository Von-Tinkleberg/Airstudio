...
const loadExtension = (
  ...
  try {
    ...
    return {
      message: `ðŸš¨ Exception caught while running createExtension. ðŸ’£ Please fix this error as this will make AirStudio crash at some point.`,
      error: true,
      dangerous: true,
      rawError: ex,
    };
  ...
  try {
    ...
    return {
      message: `ðŸš¨ Exception caught while running runExtensionSanityTests. ðŸ’£ Please fix this error as this will make AirStudio crash at some point.`,
      error: true,
      dangerous: true,
      rawError: ex,
    };
