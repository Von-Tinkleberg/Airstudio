...
be used directly from AirStudio to edit/create Dialogue Trees.
...
See `LocalExternalEditorWindow.js`, `LocalResourceExternalEditors.js` and `BrowserResourceExternalEditors.js` files for the bridge that opens the Window and passes data from AirStudio to Yarn.
